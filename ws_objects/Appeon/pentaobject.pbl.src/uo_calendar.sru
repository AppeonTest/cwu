...
type p_prevyear from picture within uo_calendar
end type
type p_nextyear from picture within uo_calendar
end type
type em_date from editmask within uo_calendar
end type
type p_next from picture within uo_calendar
end type
type p_prev from picture within uo_calendar
end type
