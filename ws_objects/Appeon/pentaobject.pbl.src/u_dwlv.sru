...
private function integer of_getcolindex (string as_colname);return 1
end function
...
private function string of_setdesign (string dwsyntax, long dwheight, str_dwlv columns, str_defaultvalue defaultvalue, str_uservalue uservalue);return ''
end function
