$PBExportHeader$w_role_main2.srw
forward
global type w_role_main2 from w_default_templet
end type
type uc_rmsave from u_picture within w_role_main2
end type
type uc_rminsert from u_picture within w_role_main2
end type
type uc_rmdelete from u_picture within w_role_main2
end type
type uc_rusave from u_picture within w_role_main2
end type
type uc_rudelete from u_picture within w_role_main2
end type
type uc_ruinsert from u_picture within w_role_main2
end type
type dw_userrole from uo_dwlv within w_role_main2
end type
type dw_pgm_role from uo_dwlv within w_role_main2
end type
type st_1 from statictext within w_role_main2
end type
type st_2 from statictext within w_role_main2
end type
type st_3 from statictext within w_role_main2
end type
type uc_rpconfig from uo_imgbtn within w_role_main2
end type
type uo_copy from uo_imgbtn within w_role_main2
end type
type p_2 from picture within w_role_main2
end type
type p_1 from picture within w_role_main2
end type
type p_3 from picture within w_role_main2
end type
type r_1 from rectangle within w_role_main2
end type
type r_2 from rectangle within w_role_main2
end type
type r_3 from rectangle within w_role_main2
end type
type r_4 from rectangle within w_role_main2
end type
end forward
...
global w_role_main2 w_role_main2
...
type ln_templeft from w_default_templet`ln_templeft within w_role_main2
end type

type ln_tempright from w_default_templet`ln_tempright within w_role_main2
end type

type ln_temptop from w_default_templet`ln_temptop within w_role_main2
end type

type ln_tempbuttom from w_default_templet`ln_tempbuttom within w_role_main2
end type

type ln_tempbutton from w_default_templet`ln_tempbutton within w_role_main2
end type

type ln_tempstart from w_default_templet`ln_tempstart within w_role_main2
end type

type uc_retrieve from w_default_templet`uc_retrieve within w_role_main2
...
type uc_save from w_default_templet`uc_save within w_role_main2
boolean visible = false
integer x = 4192
end type

type uc_run from w_default_templet`uc_run within w_role_main2
boolean visible = false
integer x = 2222
integer width = 306
integer height = 96
...
type uc_print from w_default_templet`uc_print within w_role_main2
boolean visible = false
end type

type uc_ok from w_default_templet`uc_ok within w_role_main2
boolean visible = false
end type

type uc_excel from w_default_templet`uc_excel within w_role_main2
boolean visible = false
integer width = 306
integer height = 96
boolean originalsize = true
...
type uc_delete from w_default_templet`uc_delete within w_role_main2
boolean visible = false
integer x = 4110
integer width = 306
integer height = 96
...
type uc_close from w_default_templet`uc_close within w_role_main2
boolean visible = false
end type

type uc_cancel from w_default_templet`uc_cancel within w_role_main2
boolean visible = false
integer x = 2866
integer width = 306
integer height = 96
...
type uc_insert from w_default_templet`uc_insert within w_role_main2
boolean visible = false
integer x = 3461
integer width = 306
integer height = 96
...
type dw_tran from w_default_templet`dw_tran within w_role_main2
integer x = 46
integer y = 252
integer width = 1248
integer height = 424
...
type dw_view from w_default_templet`dw_view within w_role_main2
integer x = 46
integer y = 708
integer width = 1248
integer height = 1404
