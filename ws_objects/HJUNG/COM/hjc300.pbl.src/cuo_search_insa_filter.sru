$PBExportHeader$cuo_search_insa_filter.sru
$PBExportComments$검색조건(학번과 성명으로 검색하여 조회)
forward
global type cuo_search_insa_filter from userobject
end type
type st_remark from statictext within cuo_search_insa_filter
end type
type rb_hakbun from radiobutton within cuo_search_insa_filter
end type
type rb_name from radiobutton within cuo_search_insa_filter
end type
type pb_find from picturebutton within cuo_search_insa_filter
end type
type sle_name from singlelineedit within cuo_search_insa_filter
end type
end forward
...
global cuo_search_insa_filter cuo_search_insa_filter
...
on cuo_search_insa_filter.create
...
on cuo_search_insa_filter.destroy
...
long backcolor = 67108864
string text = "번호 또는 성명으로 자료를 조회할 수 있습니다. "
