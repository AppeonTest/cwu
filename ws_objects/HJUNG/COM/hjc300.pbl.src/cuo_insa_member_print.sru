$PBExportHeader$cuo_insa_member_print.sru
$PBExportComments$인사공통 성명,개인번호-출력용
forward
global type cuo_insa_member_print from userobject
end type
type st_jumin_no from statictext within cuo_insa_member_print
end type
type st_11 from statictext within cuo_insa_member_print
end type
type st_9 from statictext within cuo_insa_member_print
end type
type st_10 from statictext within cuo_insa_member_print
end type
type st_12 from statictext within cuo_insa_member_print
end type
type st_13 from statictext within cuo_insa_member_print
end type
type st_14 from statictext within cuo_insa_member_print
end type
type st_15 from statictext within cuo_insa_member_print
end type
type st_16 from statictext within cuo_insa_member_print
end type
type st_17 from statictext within cuo_insa_member_print
end type
type st_18 from statictext within cuo_insa_member_print
end type
type st_8 from statictext within cuo_insa_member_print
end type
type st_7 from statictext within cuo_insa_member_print
end type
type st_6 from statictext within cuo_insa_member_print
end type
type st_5 from statictext within cuo_insa_member_print
end type
type st_4 from statictext within cuo_insa_member_print
end type
type st_3 from statictext within cuo_insa_member_print
end type
type st_2 from statictext within cuo_insa_member_print
end type
type cb_help from commandbutton within cuo_insa_member_print
end type
type sle_member_no from singlelineedit within cuo_insa_member_print
end type
type sle_kname from singlelineedit within cuo_insa_member_print
end type
type st_1 from statictext within cuo_insa_member_print
end type
type st_jikmu_nm from statictext within cuo_insa_member_print
end type
type st_firsthire_date from statictext within cuo_insa_member_print
end type
type st_sal_class from statictext within cuo_insa_member_print
end type
type st_duty_nm from statictext within cuo_insa_member_print
end type
type st_jikwi_nm from statictext within cuo_insa_member_print
end type
type st_jikjong_nm from statictext within cuo_insa_member_print
end type
type st_dept_nm from statictext within cuo_insa_member_print
end type
end forward
...
global cuo_insa_member_print cuo_insa_member_print
...
on cuo_insa_member_print.create
...
on cuo_insa_member_print.destroy
