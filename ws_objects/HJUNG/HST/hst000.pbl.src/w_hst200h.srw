$PBExportHeader$w_hst200h.srw
$PBExportComments$규격response
forward
global type w_hst200h from w_response
end type
type dw_head from datawindow within w_hst200h
end type
type pb_retrieve from picture within w_hst200h
end type
type gb_1 from groupbox within w_hst200h
end type
type gb_2 from groupbox within w_hst200h
end type
end forward
...
type pb_cancel from w_response`pb_cancel within w_hst200h
integer x = 2574
integer y = 1480
integer taborder = 40
...
type pb_ok from w_response`pb_ok within w_hst200h
integer x = 2277
integer y = 1480
integer taborder = 30
end type
...
type st_sttitle00001 from w_response`st_sttitle00001 within w_hst200h
integer y = 1480
integer width = 1970
end type

type dw_responst from w_response`dw_responst within w_hst200h
integer x = 41
integer y = 260
integer width = 2793
integer height = 1196
string dataobject = "d_hst200h_1"
end type
