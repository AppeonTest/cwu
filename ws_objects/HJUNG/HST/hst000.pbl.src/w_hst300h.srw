$PBExportHeader$w_hst300h.srw
$PBExportComments$모델 response
forward
global type w_hst300h from w_response
end type
type dw_head from datawindow within w_hst300h
end type
type pb_retrieve from picture within w_hst300h
end type
type gb_1 from groupbox within w_hst300h
end type
type gb_2 from groupbox within w_hst300h
end type
end forward
...
type pb_cancel from w_response`pb_cancel within w_hst300h
integer x = 2569
integer y = 1480
integer taborder = 40
end type

type pb_ok from w_response`pb_ok within w_hst300h
integer x = 2286
integer y = 1480
integer taborder = 30
end type
...
type st_sttitle00001 from w_response`st_sttitle00001 within w_hst300h
integer y = 1480
integer width = 1975
end type

type dw_responst from w_response`dw_responst within w_hst300h
integer x = 41
integer y = 260
integer width = 2793
integer height = 1196
