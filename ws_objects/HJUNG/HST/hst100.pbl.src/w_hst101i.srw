$PBExportHeader$w_hst101i.srw
$PBExportComments$품목분류 관리
forward
global type w_hst101i from w_msheet
end type
type tab_1 from tab within w_hst101i
end type
...
type uo_1 from u_tab within w_hst101i
end type
end forward
	  ...
	  IF f_chk_null( dw_lname, ls_lcolarry ) = 1 AND f_chk_null( dw_mname, ls_mcolarry ) = 1 THEN 
        ...
        FOR i = 1 TO ll_mrow
		 ...
		 Do While ll_ModRow > 0 
			dw_lname.object.job_uid[ll_ModRow] = gstru_uid_uname.uid		//수정자
		   dw_lname.object.job_date[ll_ModRow] = f_sysdate()           // 오늘 일자 
		   dw_lname.object.job_add[ll_ModRow] = gstru_uid_uname.address  //IP
		 ...
		 Do While ll_ModRow > 0 
			dw_mname.object.job_uid[ll_ModRow] = gstru_uid_uname.uid		//수정자
		   dw_mname.object.job_date[ll_ModRow] = f_sysdate()           // 오늘 일자 
		   dw_mname.object.job_add[ll_ModRow] = gstru_uid_uname.address  //IP
...
type ln_templeft from w_msheet`ln_templeft within w_hst101i
end type

type ln_tempright from w_msheet`ln_tempright within w_hst101i
end type

type ln_temptop from w_msheet`ln_temptop within w_hst101i
end type

type ln_tempbuttom from w_msheet`ln_tempbuttom within w_hst101i
end type

type ln_tempbutton from w_msheet`ln_tempbutton within w_hst101i
end type

type ln_tempstart from w_msheet`ln_tempstart within w_hst101i
end type

type uc_retrieve from w_msheet`uc_retrieve within w_hst101i
end type

type uc_insert from w_msheet`uc_insert within w_hst101i
end type

type uc_delete from w_msheet`uc_delete within w_hst101i
end type

type uc_save from w_msheet`uc_save within w_hst101i
end type

type uc_excel from w_msheet`uc_excel within w_hst101i
end type

type uc_print from w_msheet`uc_print within w_hst101i
end type

type st_line1 from w_msheet`st_line1 within w_hst101i
...
type st_line2 from w_msheet`st_line2 within w_hst101i
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
string facename = "Tahoma"
...
type st_line3 from w_msheet`st_line3 within w_hst101i
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
string facename = "Tahoma"
...
type uc_excelroad from w_msheet`uc_excelroad within w_hst101i
end type

type ln_dwcon from w_msheet`ln_dwcon within w_hst101i
end type
...
dw_mname.object.worker[ll_mrow] = gstru_uid_uname.uid      // 작업자 
dw_mname.object.work_date[ll_mrow] = f_sysdate()           // 오늘 일자 
dw_mname.object.ipaddr[ll_mrow] = gstru_uid_uname.address  //IP
...
idw_name.object.worker[ll_row] = gstru_uid_uname.uid      // 작업자 
idw_name.object.work_date[ll_row] = f_sysdate()           // 오늘 일자 
idw_name.object.ipaddr[ll_row] = gstru_uid_uname.address  //IP
