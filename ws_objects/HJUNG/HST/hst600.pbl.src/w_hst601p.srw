$PBExportHeader$w_hst601p.srw
$PBExportComments$학과별 일정금액 이상 보유현황
forward
global type w_hst601p from w_msheet
end type
type dw_select from datawindow within w_hst601p
end type
type dw_print from datawindow within w_hst601p
end type
type gb_1 from groupbox within w_hst601p
end type
end forward
...
ls_statement += " and A.purchase_price >= "+ll_amt_f +"	 and  A.purchase_price <= "+ll_amt_t
end if	
...
avc_data.SetProperty('title', "학과별 비품 보유 현황")
...
type ln_templeft from w_msheet`ln_templeft within w_hst601p
end type

type ln_tempright from w_msheet`ln_tempright within w_hst601p
end type

type ln_temptop from w_msheet`ln_temptop within w_hst601p
end type

type ln_tempbuttom from w_msheet`ln_tempbuttom within w_hst601p
end type

type ln_tempbutton from w_msheet`ln_tempbutton within w_hst601p
end type

type ln_tempstart from w_msheet`ln_tempstart within w_hst601p
end type

type uc_retrieve from w_msheet`uc_retrieve within w_hst601p
end type

type uc_insert from w_msheet`uc_insert within w_hst601p
end type

type uc_delete from w_msheet`uc_delete within w_hst601p
end type

type uc_save from w_msheet`uc_save within w_hst601p
end type

type uc_excel from w_msheet`uc_excel within w_hst601p
end type

type uc_print from w_msheet`uc_print within w_hst601p
end type

type st_line1 from w_msheet`st_line1 within w_hst601p
end type

type st_line2 from w_msheet`st_line2 within w_hst601p
end type

type st_line3 from w_msheet`st_line3 within w_hst601p
end type

type uc_excelroad from w_msheet`uc_excelroad within w_hst601p
end type

type ln_dwcon from w_msheet`ln_dwcon within w_hst601p
end type
