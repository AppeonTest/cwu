$PBExportHeader$w_hst609p.srw
$PBExportComments$자산대장 연숙지출력
forward
global type w_hst609p from w_msheet
end type
type tab_1 from tab within w_hst609p
end type
...
type rb_build from radiobutton within tabpage_1
end type
...
type uo_1 from u_tab within w_hst609p
end type
end forward
...
ELSE
		ls_header += 	"기간:" +ls_datefr_nm+ "-" +ls_dateto_nm+"  "
END IF
...
IF tab_1.tabpage_1.dw_print.Retrieve( ls_IdNo,        & 
			...
			tab_1.tabpage_1.dw_print.object.t_2.text = ""			
		
		ELSE
			tab_1.tabpage_1.dw_print.object.t_2.text = ls_header	
			//wf_setmenu('P',TRUE)
		END IF
	return 1
//////////////////////////////////////////////////////////////////////////////////////////
...
type ln_templeft from w_msheet`ln_templeft within w_hst609p
end type

type ln_tempright from w_msheet`ln_tempright within w_hst609p
end type

type ln_temptop from w_msheet`ln_temptop within w_hst609p
end type

type ln_tempbuttom from w_msheet`ln_tempbuttom within w_hst609p
end type

type ln_tempbutton from w_msheet`ln_tempbutton within w_hst609p
end type

type ln_tempstart from w_msheet`ln_tempstart within w_hst609p
end type

type uc_retrieve from w_msheet`uc_retrieve within w_hst609p
end type

type uc_insert from w_msheet`uc_insert within w_hst609p
end type

type uc_delete from w_msheet`uc_delete within w_hst609p
end type

type uc_save from w_msheet`uc_save within w_hst609p
end type

type uc_excel from w_msheet`uc_excel within w_hst609p
end type

type uc_print from w_msheet`uc_print within w_hst609p
end type

type st_line1 from w_msheet`st_line1 within w_hst609p
...
type st_line2 from w_msheet`st_line2 within w_hst609p
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
string facename = "Tahoma"
...
type st_line3 from w_msheet`st_line3 within w_hst609p
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
string facename = "Tahoma"
...
type uc_excelroad from w_msheet`uc_excelroad within w_hst609p
end type

type ln_dwcon from w_msheet`ln_dwcon within w_hst609p
end type
...
event clicked;tab_1.tabpage_1.dw_print.dataobject = 'd_hst201a_59_6'                 // 자산번호순
...
event clicked;tab_1.tabpage_1.dw_print.dataobject = 'd_hst201a_59_9'                 // 집기비품
tab_1.tabpage_1.dw_print.settransobject(sqlca)
tab_1.tabpage_1.dw_print.Object.DataWindow.Print.Preview = 'YES'
end event
...
event clicked;tab_1.tabpage_1.dw_print.dataobject = 'd_hst201a_59_8'                 //기계기구
tab_1.tabpage_1.dw_print.settransobject(sqlca)
tab_1.tabpage_1.dw_print.Object.DataWindow.Print.Preview = 'YES'
end event
...
event clicked;tab_1.tabpage_1.dw_print.dataobject = 'd_hst201a_59_7'                 // 불용처분
tab_1.tabpage_1.dw_print.settransobject(sqlca)
tab_1.tabpage_1.dw_print.Object.DataWindow.Print.Preview = 'YES'
end event
...
event clicked;tab_1.tabpage_1.dw_print.dataobject = 'd_hst201a_59_5'                 // 부서/학과별
tab_1.tabpage_1.dw_print.settransobject(sqlca)
tab_1.tabpage_1.dw_print.Object.DataWindow.Print.Preview = 'YES'
end event
...
event clicked;tab_1.tabpage_1.dw_print.dataobject = 'd_hst201a_59_2'                 // 부서/학과별
tab_1.tabpage_1.dw_print.settransobject(sqlca)
tab_1.tabpage_1.dw_print.Object.DataWindow.Print.Preview = 'YES'
end event
...
event clicked;tab_1.tabpage_1.dw_print.dataobject = 'd_hst201a_59_1'                 // 자산번호순
tab_1.tabpage_1.dw_print.settransobject(sqlca)
tab_1.tabpage_1.dw_print.Object.DataWindow.Print.Preview = 'YES'
end event
