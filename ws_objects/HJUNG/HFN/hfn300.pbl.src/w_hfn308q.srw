$PBExportHeader$w_hfn308q.srw
$PBExportComments$전표(전표일자) 조회/출력
forward
global type w_hfn308q from w_msheet
end type
type dw_con from uo_dwfree within w_hfn308q
end type
type dw_list from uo_dwgrid within w_hfn308q
end type
type dw_detail1 from uo_dwgrid within w_hfn308q
end type
end forward
...
dw_list.reset()
if dw_list.retrieve(gi_acct_class, li_slip_class, ls_from_date, ls_to_date, li_step_opt, ls_acct_code) < 1 then
	dw_detail1.reset()
end if
...
//	messagebox('확인', '전표기간(To)을 올바르게 입력하시기 바랍니다.')
//	em_to_date.setfocus()
//	return
//end if
...
type ln_templeft from w_msheet`ln_templeft within w_hfn308q
end type

type ln_tempright from w_msheet`ln_tempright within w_hfn308q
end type

type ln_temptop from w_msheet`ln_temptop within w_hfn308q
end type

type ln_tempbuttom from w_msheet`ln_tempbuttom within w_hfn308q
end type

type ln_tempbutton from w_msheet`ln_tempbutton within w_hfn308q
end type

type ln_tempstart from w_msheet`ln_tempstart within w_hfn308q
end type

type uc_retrieve from w_msheet`uc_retrieve within w_hfn308q
end type

type uc_insert from w_msheet`uc_insert within w_hfn308q
end type

type uc_delete from w_msheet`uc_delete within w_hfn308q
end type

type uc_save from w_msheet`uc_save within w_hfn308q
end type

type uc_excel from w_msheet`uc_excel within w_hfn308q
end type

type uc_print from w_msheet`uc_print within w_hfn308q
end type

type st_line1 from w_msheet`st_line1 within w_hfn308q
end type

type st_line2 from w_msheet`st_line2 within w_hfn308q
end type

type st_line3 from w_msheet`st_line3 within w_hfn308q
end type

type uc_excelroad from w_msheet`uc_excelroad within w_hfn308q
end type

type ln_dwcon from w_msheet`ln_dwcon within w_hfn308q
end type
