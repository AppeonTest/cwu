$PBExportHeader$w_hfn603q.srw
$PBExportComments$기타/사업소득 지급조서
forward
global type w_hfn603q from w_tabsheet
end type
...
//
//
//idw_print.dataobject = 'd_hfn603q_2_1'
//idw_print.settransobject(sqlca)
//idw_print.modify("datawindow.zoom = 100")
...
avc_data.SetProperty('title', "원천징수영수증")
...
type ln_templeft from w_tabsheet`ln_templeft within w_hfn603q
end type

type ln_tempright from w_tabsheet`ln_tempright within w_hfn603q
end type

type ln_temptop from w_tabsheet`ln_temptop within w_hfn603q
end type

type ln_tempbuttom from w_tabsheet`ln_tempbuttom within w_hfn603q
end type

type ln_tempbutton from w_tabsheet`ln_tempbutton within w_hfn603q
end type

type ln_tempstart from w_tabsheet`ln_tempstart within w_hfn603q
end type

type uc_retrieve from w_tabsheet`uc_retrieve within w_hfn603q
end type

type uc_insert from w_tabsheet`uc_insert within w_hfn603q
end type

type uc_delete from w_tabsheet`uc_delete within w_hfn603q
end type

type uc_save from w_tabsheet`uc_save within w_hfn603q
end type

type uc_excel from w_tabsheet`uc_excel within w_hfn603q
end type

type uc_print from w_tabsheet`uc_print within w_hfn603q
end type

type st_line1 from w_tabsheet`st_line1 within w_hfn603q
...
type st_line2 from w_tabsheet`st_line2 within w_hfn603q
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
string facename = "Tahoma"
...
type st_line3 from w_tabsheet`st_line3 within w_hfn603q
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
string facename = "Tahoma"
...
type uc_excelroad from w_tabsheet`uc_excelroad within w_hfn603q
end type

type ln_dwcon from w_tabsheet`ln_dwcon within w_hfn603q
end type

type tab_sheet from w_tabsheet`tab_sheet within w_hfn603q
integer y = 320
integer width = 4379
integer height = 1960
integer taborder = 40
...
type uo_tab from w_tabsheet`uo_tab within w_hfn603q
long backcolor = 1073741824
end type

type dw_con from w_tabsheet`dw_con within w_hfn603q
...
Choose Case dwo.name
	Case 'gubun'
		If data = '1' Then
			...
			idw_list.dataobject 	= 'd_hfn603q_1'
			idw_print.dataobject = 'd_hfn603q_2'
		Else
...
type st_con from w_tabsheet`st_con within w_hfn603q
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
string facename = "Tahoma"
