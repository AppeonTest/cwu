$PBExportHeader$w_hfn613b.srw
$PBExportComments$[산학협력단]기타/사업소득 지급조서 생성
forward
global type w_hfn613b from w_msheet
end type
type sle_name from singlelineedit within w_hfn613b
end type
type sle_sosok from singlelineedit within w_hfn613b
end type
type st_9 from statictext within w_hfn613b
end type
type st_3 from statictext within w_hfn613b
end type
type sle_c from singlelineedit within w_hfn613b
end type
type st_8 from statictext within w_hfn613b
end type
type sle_b from singlelineedit within w_hfn613b
end type
type st_7 from statictext within w_hfn613b
end type
type sle_a from singlelineedit within w_hfn613b
end type
type st_6 from statictext within w_hfn613b
end type
type em_date from editmask within w_hfn613b
end type
type st_5 from statictext within w_hfn613b
end type
type sle_tel from singlelineedit within w_hfn613b
end type
type st_4 from statictext within w_hfn613b
end type
type em_year from editmask within w_hfn613b
end type
type st_1 from statictext within w_hfn613b
end type
type ddlb_gubun from dropdownlistbox within w_hfn613b
end type
type st_2 from statictext within w_hfn613b
end type
type cb_1 from uo_imgbtn within w_hfn613b
end type
type dw_list from uo_dwgrid within w_hfn613b
end type
type gb_1 from groupbox within w_hfn613b
end type
type gb_2 from groupbox within w_hfn613b
end type
end forward
...
date		ld_date
string	ls_date
string	ls_tax_office_code, ls_business_no, ls_campus_name, ls_president
string 	ls_sosok, ls_name, ls_tel
string	ls_income_name, ls_jumin_no, ls_geju_gubun, ls_pay_date, ls_yyyymm, ls_income_juso, ls_foreign_type
string	ls_write
string	ls_hometax
...
select	tax_office_code, 			business_no, 		
			campus_name, 				president
into		:ls_tax_office_code, 	:ls_business_no, 	
			:ls_campus_name, 			:ls_president
from		cddb.kch000m_industry	;
...
// 15 제출대상기간코드 : 연간(1.1～12.31)지급분 - 1, 폐업에 의한 수시 제출분 = 2
ls_write += '1'
// 16 공란
ls_write += space(4)
...
type ln_templeft from w_msheet`ln_templeft within w_hfn613b
end type

type ln_tempright from w_msheet`ln_tempright within w_hfn613b
end type

type ln_temptop from w_msheet`ln_temptop within w_hfn613b
end type

type ln_tempbuttom from w_msheet`ln_tempbuttom within w_hfn613b
end type

type ln_tempbutton from w_msheet`ln_tempbutton within w_hfn613b
end type

type ln_tempstart from w_msheet`ln_tempstart within w_hfn613b
end type

type uc_retrieve from w_msheet`uc_retrieve within w_hfn613b
end type

type uc_insert from w_msheet`uc_insert within w_hfn613b
end type

type uc_delete from w_msheet`uc_delete within w_hfn613b
end type

type uc_save from w_msheet`uc_save within w_hfn613b
end type

type uc_excel from w_msheet`uc_excel within w_hfn613b
end type

type uc_print from w_msheet`uc_print within w_hfn613b
end type

type st_line1 from w_msheet`st_line1 within w_hfn613b
...
type st_line2 from w_msheet`st_line2 within w_hfn613b
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
string facename = "Tahoma"
...
type st_line3 from w_msheet`st_line3 within w_hfn613b
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
string facename = "Tahoma"
...
type uc_excelroad from w_msheet`uc_excelroad within w_hfn613b
end type

type ln_dwcon from w_msheet`ln_dwcon within w_hfn613b
end type
...
event selectionchanged;choose case finditem(text, 0)
	case 1
		dw_list.dataobject 	= 'd_hfn613b_1'
//	case 2
