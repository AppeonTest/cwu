$PBExportHeader$w_hfn005m.srw
$PBExportComments$관리항목에 의한 차입금 조회
forward
global type w_hfn005m from window
end type
type dw_head from datawindow within w_hfn005m
end type
type st_1 from statictext within w_hfn005m
end type
type cb_retrieve from commandbutton within w_hfn005m
end type
type cb_cancel from commandbutton within w_hfn005m
end type
type cb_ok from commandbutton within w_hfn005m
end type
type dw_main from cuo_dwwindow_one_hin within w_hfn005m
end type
type gb_1 from groupbox within w_hfn005m
end type
end forward
...
global w_hfn005m w_hfn005m

type variables
integer	ii_loan_class
end variables
...
dw_main.Retrieve(ii_loan_class)
dw_main.setfocus()
...
lstr_com.ls_item[1] = trim(dw_main.getitemstring(ll_getrow, 'loan_no'))
lstr_com.ls_item[2] = ''
