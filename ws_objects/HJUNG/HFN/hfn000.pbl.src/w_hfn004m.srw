$PBExportHeader$w_hfn004m.srw
$PBExportComments$관리항목에 의한 어음/수표 조회
forward
global type w_hfn004m from window
end type
type dw_head from datawindow within w_hfn004m
end type
type st_1 from statictext within w_hfn004m
end type
type cb_retrieve from commandbutton within w_hfn004m
end type
type cb_cancel from commandbutton within w_hfn004m
end type
type cb_ok from commandbutton within w_hfn004m
end type
type dw_main from cuo_dwwindow_one_hin within w_hfn004m
end type
type gb_1 from groupbox within w_hfn004m
end type
end forward
...
global w_hfn004m w_hfn004m

type variables
integer	ii_notes_class
end variables
...
dw_main.Retrieve(ii_notes_class)
dw_main.setfocus()
...
dw_main.getchild('bal_bank_code', ldw_temp)
...
lstr_com.ls_item[1] = trim(dw_main.getitemstring(ll_getrow, 'notes_no'))
lstr_com.ls_item[2] = ''
