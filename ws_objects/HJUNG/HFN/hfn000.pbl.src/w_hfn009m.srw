$PBExportHeader$w_hfn009m.srw
$PBExportComments$관리항목에 의한 카드번호 조회
forward
global type w_hfn009m from window
end type
type cb_retrieve from commandbutton within w_hfn009m
end type
type cb_cancel from commandbutton within w_hfn009m
end type
type cb_ok from commandbutton within w_hfn009m
end type
type dw_main from cuo_dwwindow_one_hin within w_hfn009m
end type
end forward
...
lstr_com.ls_item[1] = trim(dw_main.getitemstring(ll_getrow, 'card_no'))
lstr_com.ls_item[2] = ''
