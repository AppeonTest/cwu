$PBExportHeader$w_hfn106a_help.srw
$PBExportComments$기타소득자 조회
forward
global type w_hfn106a_help from window
end type
type cb_cancel from u_picture within w_hfn106a_help
end type
type cb_ok from u_picture within w_hfn106a_help
end type
type cb_retrieve from u_picture within w_hfn106a_help
end type
type ddlb_1 from dropdownlistbox within w_hfn106a_help
end type
type st_3 from statictext within w_hfn106a_help
end type
type em_data from editmask within w_hfn106a_help
end type
type dw_main from cuo_dwwindow_one_hin within w_hfn106a_help
end type
type st_1 from statictext within w_hfn106a_help
end type
type gb_1 from groupbox within w_hfn106a_help
end type
end forward
...
global w_hfn106a_help w_hfn106a_help
...
integer height = 1360
integer taborder = 70
string dataobject = "d_hfn106a_help"
