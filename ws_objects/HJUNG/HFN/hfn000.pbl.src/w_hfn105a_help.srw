$PBExportHeader$w_hfn105a_help.srw
$PBExportComments$사업소득자 조회
forward
global type w_hfn105a_help from window
end type
type cb_retrieve from u_picture within w_hfn105a_help
end type
type cb_ok from u_picture within w_hfn105a_help
end type
type cb_cancel from u_picture within w_hfn105a_help
end type
type ddlb_1 from dropdownlistbox within w_hfn105a_help
end type
type st_3 from statictext within w_hfn105a_help
end type
type em_data from editmask within w_hfn105a_help
end type
type dw_main from cuo_dwwindow_one_hin within w_hfn105a_help
end type
type st_1 from statictext within w_hfn105a_help
end type
type gb_1 from groupbox within w_hfn105a_help
end type
end forward
...
global w_hfn105a_help w_hfn105a_help
...
lstr_com.ls_item[4] = dw_main.Object.saup_no[ll_GetRow]			//사업자번호
lstr_com.ls_item[5] = dw_main.Object.sangho[ll_GetRow]			//상호
lstr_com.ls_item[6] = dw_main.Object.saup_juso[ll_GetRow]		//주소
...
integer height = 1360
integer taborder = 70
string dataobject = "d_hfn105a_help"
