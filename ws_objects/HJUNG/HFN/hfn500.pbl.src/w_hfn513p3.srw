$PBExportHeader$w_hfn513p3.srw
$PBExportComments$미지급금집행내역(new)
forward
global type w_hfn513p3 from w_hfn_print_form5
end type
type st_3 from statictext within w_hfn513p3
end type
type em_bdgt_year from editmask within w_hfn513p3
end type
type em_fr_date from editmask within w_hfn513p3
end type
type st_4 from statictext within w_hfn513p3
end type
type em_to_date from editmask within w_hfn513p3
end type
end forward
...
type st_2 from w_hfn_print_form5`st_2 within w_hfn513p3
integer x = 1513
integer y = 96
integer height = 60
end type

type uo_acct_class from w_hfn_print_form5`uo_acct_class within w_hfn513p3
boolean visible = false
integer x = 2190
integer taborder = 0
end type

type dw_print from w_hfn_print_form5`dw_print within w_hfn513p3
integer taborder = 20
string dataobject = "d_hfn513p_3"
end type
