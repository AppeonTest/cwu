$PBExportHeader$w_hfn518p.srw
$PBExportComments$수표수불명세서
forward
global type w_hfn518p from w_hfn_print_form5
end type
type st_3 from statictext within w_hfn518p
end type
type em_bdgt_year from editmask within w_hfn518p
end type
end forward
...
type st_2 from w_hfn_print_form5`st_2 within w_hfn518p
integer x = 832
end type

type uo_acct_class from w_hfn_print_form5`uo_acct_class within w_hfn518p
boolean visible = false
integer x = 2190
integer taborder = 0
end type

type dw_print from w_hfn_print_form5`dw_print within w_hfn518p
integer taborder = 20
string dataobject = "d_hfn518p_1"
end type
