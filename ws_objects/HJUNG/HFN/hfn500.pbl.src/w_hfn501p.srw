$PBExportHeader$w_hfn501p.srw
$PBExportComments$합계잔액시산표 출력(년결산용)
forward
global type w_hfn501p from w_hfn_print_form2
end type
type st_3 from statictext within w_hfn501p
end type
type em_bdgt_year from editmask within w_hfn501p
end type
end forward
...
type dw_form from w_hfn_print_form2`dw_form within w_hfn501p
integer x = 818
integer y = 872
integer taborder = 80
end type

type st_11 from w_hfn_print_form2`st_11 within w_hfn501p
boolean visible = false
integer x = 2331
integer y = 756
end type

type ddlb_acct_class from w_hfn_print_form2`ddlb_acct_class within w_hfn501p
boolean visible = false
integer x = 2674
integer y = 752
integer taborder = 70
...
type uo_slip_class from w_hfn_print_form2`uo_slip_class within w_hfn501p
boolean visible = false
integer x = 1911
integer y = 416
...
type uo_acct_class from w_hfn_print_form2`uo_acct_class within w_hfn501p
integer x = 2158
integer y = 988
integer taborder = 50
end type

type uo_year from w_hfn_print_form2`uo_year within w_hfn501p
boolean visible = false
integer x = 2002
integer y = 76
integer taborder = 60
...
type dw_print from w_hfn_print_form2`dw_print within w_hfn501p
string dataobject = "d_hfn501p_1"
end type
