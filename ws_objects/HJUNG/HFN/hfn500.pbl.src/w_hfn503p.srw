$PBExportHeader$w_hfn503p.srw
$PBExportComments$운영계산서 출력(년결산용)
forward
global type w_hfn503p from w_hfn_print_form2
end type
type st_3 from statictext within w_hfn503p
end type
type em_bdgt_year from editmask within w_hfn503p
end type
end forward
...
type dw_form from w_hfn_print_form2`dw_form within w_hfn503p
integer x = 2373
integer y = 1052
integer taborder = 80
end type

type st_11 from w_hfn_print_form2`st_11 within w_hfn503p
boolean visible = false
integer x = 1042
integer y = 1056
end type

type ddlb_acct_class from w_hfn_print_form2`ddlb_acct_class within w_hfn503p
boolean visible = false
integer x = 1349
integer y = 1040
integer taborder = 70
...
type uo_slip_class from w_hfn_print_form2`uo_slip_class within w_hfn503p
boolean visible = false
integer x = 2427
integer y = 512
...
type uo_acct_class from w_hfn_print_form2`uo_acct_class within w_hfn503p
integer x = 1065
integer y = 744
integer taborder = 50
end type

type uo_year from w_hfn_print_form2`uo_year within w_hfn503p
boolean visible = false
integer x = 2199
integer taborder = 60
end type

type dw_print from w_hfn_print_form2`dw_print within w_hfn503p
integer height = 2272
string dataobject = "d_hfn503p_1"
end type
