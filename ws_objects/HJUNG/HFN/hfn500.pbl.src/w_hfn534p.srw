$PBExportHeader$w_hfn534p.srw
$PBExportComments$수입세부리스트
forward
global type w_hfn534p from w_hfn_print_form5
end type
type st_3 from statictext within w_hfn534p
end type
type em_fr_date from editmask within w_hfn534p
end type
type em_to_date from editmask within w_hfn534p
end type
type st_1 from statictext within w_hfn534p
end type
end forward
...
ll_find = dw_print.find("left(com_acct_cd, 2) = '13'", 1, ll_end)
...
do while	ll_find > 0
	...
	dw_print.setitem(ll_find, 'com_acct_amt', dw_print.getitemnumber(ll_find, 'com_acct_amt') - ldc_acct_amt)
	...
	ll_find = dw_print.find("left(com_acct_cd, 2) = '13'", ll_find, ll_end)
loop
...
do while	ll_find > 0
	...
	if ll_slip_class = 3 then 
		messagebox(ls_acct_code, ls_acct_date+':'+string(ll_acct_no))
		dw_print.setitem(ll_find, 'com_acct_amt', 0)
	end if
...
type ln_templeft from w_hfn_print_form5`ln_templeft within w_hfn534p
end type

type ln_tempright from w_hfn_print_form5`ln_tempright within w_hfn534p
end type

type ln_temptop from w_hfn_print_form5`ln_temptop within w_hfn534p
end type

type ln_tempbuttom from w_hfn_print_form5`ln_tempbuttom within w_hfn534p
end type

type ln_tempbutton from w_hfn_print_form5`ln_tempbutton within w_hfn534p
end type

type ln_tempstart from w_hfn_print_form5`ln_tempstart within w_hfn534p
end type

type uc_retrieve from w_hfn_print_form5`uc_retrieve within w_hfn534p
end type

type uc_insert from w_hfn_print_form5`uc_insert within w_hfn534p
end type

type uc_delete from w_hfn_print_form5`uc_delete within w_hfn534p
end type

type uc_save from w_hfn_print_form5`uc_save within w_hfn534p
end type

type uc_excel from w_hfn_print_form5`uc_excel within w_hfn534p
end type

type uc_print from w_hfn_print_form5`uc_print within w_hfn534p
end type

type st_line1 from w_hfn_print_form5`st_line1 within w_hfn534p
end type

type st_line2 from w_hfn_print_form5`st_line2 within w_hfn534p
end type

type st_line3 from w_hfn_print_form5`st_line3 within w_hfn534p
end type

type uc_excelroad from w_hfn_print_form5`uc_excelroad within w_hfn534p
end type

type ln_dwcon from w_hfn_print_form5`ln_dwcon within w_hfn534p
end type

type st_2 from w_hfn_print_form5`st_2 within w_hfn534p
boolean visible = false
integer x = 1376
integer y = 100
end type

type uo_acct_class from w_hfn_print_form5`uo_acct_class within w_hfn534p
boolean visible = false
integer x = 2523
integer taborder = 0
end type

type dw_print from w_hfn_print_form5`dw_print within w_hfn534p
integer taborder = 30
string dataobject = "d_hfn534p_1"
end type

type dw_con from w_hfn_print_form5`dw_con within w_hfn534p
