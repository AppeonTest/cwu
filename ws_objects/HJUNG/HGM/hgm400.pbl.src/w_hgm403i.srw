$PBExportHeader$w_hgm403i.srw
$PBExportComments$물품발주관리
forward
global type w_hgm403i from w_tabsheet
end type
...
type dw_list1 from cuo_dwwindow_one_hin within tabpage_sheet01
end type
...
type ln_templeft from w_tabsheet`ln_templeft within w_hgm403i
end type

type ln_tempright from w_tabsheet`ln_tempright within w_hgm403i
end type

type ln_temptop from w_tabsheet`ln_temptop within w_hgm403i
end type

type ln_tempbuttom from w_tabsheet`ln_tempbuttom within w_hgm403i
end type

type ln_tempbutton from w_tabsheet`ln_tempbutton within w_hgm403i
end type

type ln_tempstart from w_tabsheet`ln_tempstart within w_hgm403i
end type

type uc_retrieve from w_tabsheet`uc_retrieve within w_hgm403i
end type

type uc_insert from w_tabsheet`uc_insert within w_hgm403i
end type

type uc_delete from w_tabsheet`uc_delete within w_hgm403i
end type

type uc_save from w_tabsheet`uc_save within w_hgm403i
end type

type uc_excel from w_tabsheet`uc_excel within w_hgm403i
end type

type uc_print from w_tabsheet`uc_print within w_hgm403i
end type

type st_line1 from w_tabsheet`st_line1 within w_hgm403i
end type

type st_line2 from w_tabsheet`st_line2 within w_hgm403i
end type

type st_line3 from w_tabsheet`st_line3 within w_hgm403i
end type

type uc_excelroad from w_tabsheet`uc_excelroad within w_hgm403i
end type

type ln_dwcon from w_tabsheet`ln_dwcon within w_hgm403i
end type

type tab_sheet from w_tabsheet`tab_sheet within w_hgm403i
integer x = 18
integer y = 12
integer width = 3835
integer height = 2484
...
this.Control[iCurrent+6]=this.dw_list1
...
type uo_tab from w_tabsheet`uo_tab within w_hgm403i
end type

type dw_con from w_tabsheet`dw_con within w_hgm403i
end type

type st_con from w_tabsheet`st_con within w_hgm403i
end type
...
//
//IF isnull(ii_apply_num) or ii_apply_num = 0 THEN
...
//END IF	
//
//em_apply_date.Enabled = TRUE
//ddlb_apply_no.Enabled = TRUE
//
//
//
/////////////////////////////////////////////////////////////////////////////////////////
