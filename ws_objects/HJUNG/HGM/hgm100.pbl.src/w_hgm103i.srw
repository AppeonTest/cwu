$PBExportHeader$w_hgm103i.srw
$PBExportComments$품목코드관리
forward
global type w_hgm103i from w_msheet
end type
type sle_name2 from singlelineedit within w_hgm103i
end type
type st_3 from statictext within w_hgm103i
end type
type sle_name from singlelineedit within w_hgm103i
end type
type st_2 from statictext within w_hgm103i
end type
type sle_code from singlelineedit within w_hgm103i
end type
type st_1 from statictext within w_hgm103i
end type
type tab_1 from tab within w_hgm103i
end type
...
type uo_tab from u_tab within w_hgm103i
end type
type gb_1 from groupbox within w_hgm103i
end type
type gb_3 from groupbox within w_hgm103i
end type
end forward
...
this.Control[iCurrent+1]=this.sle_name2
...
this.Control[iCurrent+8]=this.uo_tab
this.Control[iCurrent+9]=this.gb_1
this.Control[iCurrent+10]=this.gb_3
end on

on w_hgm103i.destroy
call super::destroy
...
// 1. 조회조건 체크
/////////////////////////////////////////////////////////////////////////////////////////
string ls_item_code, ls_item_name, ls_item_name2
...
CHOOSE CASE ll_tab
   ...
   CASE 2
        ...
        IF 	ls_item_code= '%' and ls_item_name = '%' THEN
	     tab_1.tabpage_2.dw_print.object.midd_code[tab_1.tabpage_2.dw_print.GetRow()] = '전체'
	     tab_1.tabpage_2.dw_print.object.midd_name[tab_1.tabpage_2.dw_print.GetRow()] = '전체'
        END IF
END CHOOSE
///////////////////////////////////////////////////////////////////////////////////////
...
IF ll_Row > 0 THEN
   ...
   ls_JOB_UID	  = gs_empcode	         //등록자
   ls_JOB_ADD	  = gs_ip		   //등록단말기
END IF
DO WHILE ll_Row > 0
	////////////////////////////////////////////////////////////////////////////////////
	// 3.1 수정항목 처리
...
END IF
	...
	String ls_middle_code, ls_item_code, ls_item_name, ls_item_name2 // 저장후 리스트에서 자료 찾기
	int  li_row
      ...
      ls_item_name2 = trim(sle_name2.text) + '%'
		...
		ls_middle_code = tab_1.tabpage_1.dw_main.object.item_middle[1]
	
		tab_1.tabpage_1.dw_list.retrieve(ls_item_code, ls_item_name)
		
      li_row   = tab_1.tabpage_1.dw_list.Find("item_middle = '" + ls_middle_code + "'",1,tab_1.tabpage_1.dw_list.rowcount())

//	   tab_1.tabpage_1.dw_list.SELECTROW(0    ,FALSE)
		If li_row > 0 then   
//			tab_1.tabpage_1.dw_list.SELECTROW(li_row,TRUE)	
			tab_1.tabpage_1.dw_list.Setrow(li_row)
...
avc_data.SetProperty('title', "품목 리스트")
...
type ln_templeft from w_msheet`ln_templeft within w_hgm103i
end type

type ln_tempright from w_msheet`ln_tempright within w_hgm103i
end type

type ln_temptop from w_msheet`ln_temptop within w_hgm103i
end type

type ln_tempbuttom from w_msheet`ln_tempbuttom within w_hgm103i
end type

type ln_tempbutton from w_msheet`ln_tempbutton within w_hgm103i
end type

type ln_tempstart from w_msheet`ln_tempstart within w_hgm103i
end type

type uc_retrieve from w_msheet`uc_retrieve within w_hgm103i
end type

type uc_insert from w_msheet`uc_insert within w_hgm103i
end type

type uc_delete from w_msheet`uc_delete within w_hgm103i
end type

type uc_save from w_msheet`uc_save within w_hgm103i
end type

type uc_excel from w_msheet`uc_excel within w_hgm103i
end type

type uc_print from w_msheet`uc_print within w_hgm103i
end type

type st_line1 from w_msheet`st_line1 within w_hgm103i
...
type st_line2 from w_msheet`st_line2 within w_hgm103i
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
string facename = "Tahoma"
...
type st_line3 from w_msheet`st_line3 within w_hgm103i
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
string facename = "Tahoma"
...
type uc_excelroad from w_msheet`uc_excelroad within w_hgm103i
end type

type ln_dwcon from w_msheet`ln_dwcon within w_hgm103i
end type
...
//string ls_item_no
//
//idw_name = tab_sheet.tabpage_sheet01.dw_list2
//
//idw_name.accepttext()
//
//IF currentrow <> 0 THEN
//
//	ls_item_no = idw_name.object.item_no[currentrow] 	
//	IF tab_sheet.tabpage_sheet01.dw_update.retrieve( ls_item_no ) = 0 THEN wf_insert()
//	
//END IF
//
end event
