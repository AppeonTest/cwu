$PBExportHeader$w_hgm504a.srw
$PBExportComments$수리 물품입고현황
forward
global type w_hgm504a from w_msheet
end type
type dw_acct_code from datawindow within w_hgm504a
end type
type st_5 from statictext within w_hgm504a
end type
type dw_dept_code from datawindow within w_hgm504a
end type
type st_7 from statictext within w_hgm504a
end type
type tab_1 from tab within w_hgm504a
end type
...
type st_2 from statictext within w_hgm504a
end type
type em_to_date from editmask within w_hgm504a
end type
type em_fr_date from editmask within w_hgm504a
end type
type st_1 from statictext within w_hgm504a
end type
type uo_1 from u_tab within w_hgm504a
end type
type gb_1 from groupbox within w_hgm504a
end type
end forward
...
/////////////////////////////////////////////////////////////////////////////////////
f_childretrieve(tab_1.tabpage_1.dw_main,"hst032h_audit_position","jikwi_code")         //직위
f_childretrieve(tab_1.tabpage_2.dw_print,"hst032h_audit_position","jikwi_code")
//////////////////////////////////////////////////////////////////////////////////////
// 2. 초기화 이벤트 호출
///////////////////////////////////////////////////////////////////////////////////////
...
avc_data.SetProperty('title', "수리물품 입고현황")
...
type ln_templeft from w_msheet`ln_templeft within w_hgm504a
end type

type ln_tempright from w_msheet`ln_tempright within w_hgm504a
end type

type ln_temptop from w_msheet`ln_temptop within w_hgm504a
end type

type ln_tempbuttom from w_msheet`ln_tempbuttom within w_hgm504a
end type

type ln_tempbutton from w_msheet`ln_tempbutton within w_hgm504a
end type

type ln_tempstart from w_msheet`ln_tempstart within w_hgm504a
end type

type uc_retrieve from w_msheet`uc_retrieve within w_hgm504a
end type

type uc_insert from w_msheet`uc_insert within w_hgm504a
end type

type uc_delete from w_msheet`uc_delete within w_hgm504a
end type

type uc_save from w_msheet`uc_save within w_hgm504a
end type

type uc_excel from w_msheet`uc_excel within w_hgm504a
end type

type uc_print from w_msheet`uc_print within w_hgm504a
end type

type st_line1 from w_msheet`st_line1 within w_hgm504a
end type

type st_line2 from w_msheet`st_line2 within w_hgm504a
end type

type st_line3 from w_msheet`st_line3 within w_hgm504a
end type

type uc_excelroad from w_msheet`uc_excelroad within w_hgm504a
end type

type ln_dwcon from w_msheet`ln_dwcon within w_hgm504a
end type
