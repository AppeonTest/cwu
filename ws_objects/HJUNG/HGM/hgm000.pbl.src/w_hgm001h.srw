$PBExportHeader$w_hgm001h.srw
$PBExportComments$품목 조회 response
forward
global type w_hgm001h from w_response
end type
type dw_head from datawindow within w_hgm001h
end type
type pb_retrieve from u_picture within w_hgm001h
end type
type gb_1 from groupbox within w_hgm001h
end type
type gb_2 from groupbox within w_hgm001h
end type
end forward
...
gstru_uid_uname.s_parm[8] = dw_responst.object.item_unit[ai_row]
...
type pb_cancel from w_response`pb_cancel within w_hgm001h
integer x = 2565
integer y = 1480
integer taborder = 40
end type

type pb_ok from w_response`pb_ok within w_hgm001h
integer x = 2281
integer y = 1480
integer taborder = 30
end type
...
type st_sttitle00001 from w_response`st_sttitle00001 within w_hgm001h
integer y = 1480
integer width = 1943
integer height = 88
end type

type dw_responst from w_response`dw_responst within w_hgm001h
integer x = 41
integer y = 260
integer width = 2793
integer height = 1196
string dataobject = "d_hgm001h_2"
end type
