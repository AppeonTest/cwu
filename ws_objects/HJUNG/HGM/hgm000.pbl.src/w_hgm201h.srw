$PBExportHeader$w_hgm201h.srw
$PBExportComments$인사기본정보도움말(성명,개인번호)
forward
global type w_hgm201h from window
end type
type cb_cancel from u_picture within w_hgm201h
end type
type cb_ok from u_picture within w_hgm201h
end type
type cb_retrieve from u_picture within w_hgm201h
end type
type ddlb_gubn from dropdownlistbox within w_hgm201h
end type
type st_3 from statictext within w_hgm201h
end type
type dw_main from cuo_dwwindow_one_hin within w_hgm201h
end type
type sle_member_no from singlelineedit within w_hgm201h
end type
type st_8 from statictext within w_hgm201h
end type
type sle_kname from singlelineedit within w_hgm201h
end type
type st_1 from statictext within w_hgm201h
end type
type gb_1 from groupbox within w_hgm201h
end type
end forward
