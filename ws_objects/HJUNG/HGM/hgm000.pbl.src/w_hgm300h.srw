$PBExportHeader$w_hgm300h.srw
$PBExportComments$계정과목 조회 response(비품)
forward
global type w_hgm300h from w_response
end type
type dw_head from datawindow within w_hgm300h
end type
type gb_1 from groupbox within w_hgm300h
end type
type gb_2 from groupbox within w_hgm300h
end type
end forward
...
type pb_cancel from w_response`pb_cancel within w_hgm300h
integer x = 1797
integer y = 1760
integer taborder = 40
end type

type pb_ok from w_response`pb_ok within w_hgm300h
integer x = 1509
integer y = 1760
integer taborder = 30
end type
...
type st_sttitle00001 from w_response`st_sttitle00001 within w_hgm300h
integer y = 1760
integer width = 1486
integer height = 84
end type

type dw_responst from w_response`dw_responst within w_hgm300h
integer x = 50
integer y = 260
integer width = 2002
integer height = 1464
string dataobject = "d_hgm300h_2"
end type
