$PBExportHeader$w_hac001h.srw
$PBExportComments$계정코드도움말(계정코드,계정명)-예산공통으로 자금계정조회시
forward
global type w_hac001h from window
end type
type cb_cancel from u_picture within w_hac001h
end type
type cb_ok from u_picture within w_hac001h
end type
type cb_retrieve from u_picture within w_hac001h
end type
type em_acct_code from editmask within w_hac001h
end type
type sle_acct_name from singlelineedit within w_hac001h
end type
type st_8 from statictext within w_hac001h
end type
type st_1 from statictext within w_hac001h
end type
type gb_1 from groupbox within w_hac001h
end type
type dw_main from uo_dwgrid within w_hac001h
end type
end forward
...
dw_main.Retrieve(is_acct_code,is_acct_name,ii_acct_class,is_io_gubun)
...
is_io_gubun   = lstr_com.ls_item[4]				//수입지출구분
