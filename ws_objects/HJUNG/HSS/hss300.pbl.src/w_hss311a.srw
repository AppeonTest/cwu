$PBExportHeader$w_hss311a.srw
$PBExportComments$MDF내선단자선번장
forward
global type w_hss311a from w_msheet
end type
type tab_1 from tab within w_hss311a
end type
...
type uo_1 from u_tab within w_hss311a
end type
end forward
...
ll_row      = tab_1.tabpage_1.dw_main.getrow()
ll_rowcount = tab_1.tabpage_1.dw_main.rowcount()
FOR IDX = ll_row  TO  ll_rowcount
	tab_1.tabpage_1.dw_main.Object.terminal_no[tab_1.tabpage_1.dw_main.getrow()] = string(ll_row)
NEXT
///////////////////////////////////////////////////////////////////////////////////////
...
avc_data.SetProperty('title', "MDF내선단자선번장 리스트")
...
type ln_templeft from w_msheet`ln_templeft within w_hss311a
end type

type ln_tempright from w_msheet`ln_tempright within w_hss311a
end type

type ln_temptop from w_msheet`ln_temptop within w_hss311a
end type

type ln_tempbuttom from w_msheet`ln_tempbuttom within w_hss311a
end type

type ln_tempbutton from w_msheet`ln_tempbutton within w_hss311a
end type

type ln_tempstart from w_msheet`ln_tempstart within w_hss311a
end type

type uc_retrieve from w_msheet`uc_retrieve within w_hss311a
end type

type uc_insert from w_msheet`uc_insert within w_hss311a
end type

type uc_delete from w_msheet`uc_delete within w_hss311a
end type

type uc_save from w_msheet`uc_save within w_hss311a
end type

type uc_excel from w_msheet`uc_excel within w_hss311a
end type

type uc_print from w_msheet`uc_print within w_hss311a
end type

type st_line1 from w_msheet`st_line1 within w_hss311a
...
type st_line2 from w_msheet`st_line2 within w_hss311a
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
string facename = "Tahoma"
...
type st_line3 from w_msheet`st_line3 within w_hss311a
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
string facename = "Tahoma"
...
type uc_excelroad from w_msheet`uc_excelroad within w_hss311a
end type

type ln_dwcon from w_msheet`ln_dwcon within w_hss311a
end type
