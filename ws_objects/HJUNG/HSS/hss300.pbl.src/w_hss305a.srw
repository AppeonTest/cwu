$PBExportHeader$w_hss305a.srw
$PBExportComments$소화전및 소화기설치 현황관리
forward
global type w_hss305a from w_msheet
end type
type tab_1 from tab within w_hss305a
end type
...
type uo_1 from u_tab within w_hss305a
end type
end forward
...
////	RETURN
////ELSE
////	select count(a.from_date)
////       into :ll_fr_date
////       from  stdb.hst301h a
////	    where a.gubun = '1';
////		 
////	    for li_idx = 1 to ll_GetRow
////          tab_1.tabpage_1.dw_main.Object.seq_no[li_idx] = ll_fr_date + li_idx
////       next
////END IF 
//
/////////////////////////////////////////////////////////////////////////////////////////
//// 3. 디폴티값 셋팅
/////////////////////////////////////////////////////////////////////////////////////////
//String ls_buil_no, ls_buil_name,ls_cnt3_num
//ls_buil_no = tab_1.tabpage_1.dw_list.object.buil_no[ll_GetRow]
//ls_buil_name = tab_1.tabpage_1.dw_list.object.buil_name[ll_GetRow]
//
//tab_1.tabpage_1.dw_main.SetItem(1,'buil_no',ls_buil_no)
//tab_1.tabpage_1.dw_main.SetItem(1,'buil_name',ls_buil_name)
//tab_1.tabpage_1.dw_main.object.cnt3[ll_GetRow] = 1
/////////////////////////////////////////////////////////////////////////////////////////
...
avc_data.SetProperty('title', "소화전및 소화기 설치 현황리스트")
...
type ln_templeft from w_msheet`ln_templeft within w_hss305a
end type

type ln_tempright from w_msheet`ln_tempright within w_hss305a
end type

type ln_temptop from w_msheet`ln_temptop within w_hss305a
end type

type ln_tempbuttom from w_msheet`ln_tempbuttom within w_hss305a
end type

type ln_tempbutton from w_msheet`ln_tempbutton within w_hss305a
end type

type ln_tempstart from w_msheet`ln_tempstart within w_hss305a
end type

type uc_retrieve from w_msheet`uc_retrieve within w_hss305a
end type

type uc_insert from w_msheet`uc_insert within w_hss305a
end type

type uc_delete from w_msheet`uc_delete within w_hss305a
end type

type uc_save from w_msheet`uc_save within w_hss305a
end type

type uc_excel from w_msheet`uc_excel within w_hss305a
end type

type uc_print from w_msheet`uc_print within w_hss305a
end type

type st_line1 from w_msheet`st_line1 within w_hss305a
...
type st_line2 from w_msheet`st_line2 within w_hss305a
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
string facename = "Tahoma"
...
type st_line3 from w_msheet`st_line3 within w_hss305a
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
string facename = "Tahoma"
...
type uc_excelroad from w_msheet`uc_excelroad within w_hss305a
end type

type ln_dwcon from w_msheet`ln_dwcon within w_hss305a
end type
