$PBExportHeader$w_hss313a.srw
$PBExportComments$소화기관리
forward
global type w_hss313a from w_msheet
end type
type tab_1 from tab within w_hss313a
end type
...
type uo_1 from u_tab within w_hss313a
end type
end forward
...
tab_1.tabpage_2.dw_print.Object.DataWindow.Zoom = 85
...
// 2. 자료추가
///////////////////////////////////////////////////////////////////////////////////////
Long	ll_GetRow, ll_RowCnt, ll_Row
...
ELSE
   ...
   FOR ll_Row = ll_GetRow TO ll_RowCnt
...
///////////////////////////////////////////////////////////////////////////////////////
Long		ll_GetRow, ll_pur_date, li_idx
String ls_buil_no
...
///////////////////////////////////////////////////////////////////////////////////////
String	ls_Msg
Long		ll_DeleteCnt,ll_DeleteRow, ll_DeleteRowCnt, ll_Row
///////////////////////////////////////////////////////////////////////////////////////
// 3. 삭제처리.
///////////////////////////////////////////////////////////////////////////////////////
...
ll_DeleteRowCnt = tab_1.tabpage_1.dw_main.RowCount()
...
ll_RowCnt = tab_1.tabpage_2.dw_print.Retrieve(ls_buil_no)
...
ls_NotNullCol[2] = 'floor_no/층번호'
ls_NotNullCol[3] = 'seq_no/호실번호'
//ls_NotNullCol[4] = 'terminal_no/단자번호'
//ls_NotNullCol[5] = 'extension_no/내선번호'
IF f_chk_null(tab_1.tabpage_1.dw_main,ls_NotNullCol) = -1 THEN RETURN -1
///////////////////////////////////////////////////////////////////////////////////////////////////////////
//2_1.날자체크 
///////////////////////////////////////////////////////////////////////////////////////////////////////////

string ls_pur_date,ls_made_date, ls_maint_date

integer li_check
li_check = tab_1.tabpage_1.dw_main.getnextmodified(0, Primary!)

IF li_check <> 0 THEN ls_pur_date = trim(tab_1.tabpage_1.dw_main.object.pur_date[li_check])
If isnull(ls_pur_date) or ls_pur_date = '' then
 else
   if isdate(String(ls_pur_date,'@@@@/@@/@@')) then
    else
	   MessageBox('확인','구입일자가 잘못 되었습니다.~r' +ls_pur_date+ '의 일자를 확인 하여 주십시요.')
	   return -1
   end IF
end IF
IF li_check <> 0 THEN ls_made_date = trim(tab_1.tabpage_1.dw_main.object.made_date[li_check])
If isnull(ls_made_date) or ls_made_date = '' then
 else
  IF isdate(String(ls_made_date,'@@@@/@@/@@')) then
    else
	  MessageBox('확인','제조일자가 잘못 되었습니다.~r' +ls_made_date+ '의 일자를 확인 하여 주십시요.')
	   return -1
  end IF
end if
IF li_check <> 0 THEN ls_maint_date = trim(tab_1.tabpage_1.dw_main.object.maint_date[li_check])
If isnull(ls_maint_date) or ls_maint_date = '' then
 else
  IF isdate(String(ls_maint_date,'@@@@/@@/@@')) then
    else
	  MessageBox('확인','정비일자가 잘못 되었습니다.~r' +ls_maint_date+ '의 일자를 확인 하여 주십시요.')
	   return -1
  end IF
end if
///////////////////////////////////////////////////////////////////////////////////////
...
avc_data.SetProperty('title', "소화기관리 리스트")
...
type ln_templeft from w_msheet`ln_templeft within w_hss313a
end type

type ln_tempright from w_msheet`ln_tempright within w_hss313a
end type

type ln_temptop from w_msheet`ln_temptop within w_hss313a
end type

type ln_tempbuttom from w_msheet`ln_tempbuttom within w_hss313a
end type

type ln_tempbutton from w_msheet`ln_tempbutton within w_hss313a
end type

type ln_tempstart from w_msheet`ln_tempstart within w_hss313a
end type

type uc_retrieve from w_msheet`uc_retrieve within w_hss313a
end type

type uc_insert from w_msheet`uc_insert within w_hss313a
end type

type uc_delete from w_msheet`uc_delete within w_hss313a
end type

type uc_save from w_msheet`uc_save within w_hss313a
end type

type uc_excel from w_msheet`uc_excel within w_hss313a
end type

type uc_print from w_msheet`uc_print within w_hss313a
end type

type st_line1 from w_msheet`st_line1 within w_hss313a
...
type st_line2 from w_msheet`st_line2 within w_hss313a
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
string facename = "Tahoma"
...
type st_line3 from w_msheet`st_line3 within w_hss313a
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
string facename = "Tahoma"
...
type uc_excelroad from w_msheet`uc_excelroad within w_hss313a
end type

type ln_dwcon from w_msheet`ln_dwcon within w_hss313a
end type
