$PBExportHeader$w_hss304a.srw
$PBExportComments$오수정화조관리
forward
global type w_hss304a from w_msheet
end type
type tab_1 from tab within w_hss304a
end type
...
type uo_1 from u_tab within w_hss304a
end type
end forward
...
func.of_design_dw(tab_1.tabpage_1.dw_main)
...
//tab_1.tabpage_1.dw_main.SetItem(1,'hst240m_buil_name',ls_buil_name)
/////////////////////////////////////////////////////////////////////////////////////////
...
avc_data.SetProperty('title', "오수정화조 리스트")
...
type ln_templeft from w_msheet`ln_templeft within w_hss304a
end type

type ln_tempright from w_msheet`ln_tempright within w_hss304a
end type

type ln_temptop from w_msheet`ln_temptop within w_hss304a
end type

type ln_tempbuttom from w_msheet`ln_tempbuttom within w_hss304a
end type

type ln_tempbutton from w_msheet`ln_tempbutton within w_hss304a
end type

type ln_tempstart from w_msheet`ln_tempstart within w_hss304a
end type

type uc_retrieve from w_msheet`uc_retrieve within w_hss304a
end type

type uc_insert from w_msheet`uc_insert within w_hss304a
end type

type uc_delete from w_msheet`uc_delete within w_hss304a
end type

type uc_save from w_msheet`uc_save within w_hss304a
end type

type uc_excel from w_msheet`uc_excel within w_hss304a
end type

type uc_print from w_msheet`uc_print within w_hss304a
end type

type st_line1 from w_msheet`st_line1 within w_hss304a
...
type st_line2 from w_msheet`st_line2 within w_hss304a
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
string facename = "Tahoma"
...
type st_line3 from w_msheet`st_line3 within w_hss304a
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
string facename = "Tahoma"
...
type uc_excelroad from w_msheet`uc_excelroad within w_hss304a
end type

type ln_dwcon from w_msheet`ln_dwcon within w_hss304a
end type
...
integer height = 1880
integer taborder = 40
string dataobject = "d_hss304a_2"
boolean border = false
borderstyle borderstyle = stylebox!
end type

event constructor;call super::constructor;f_pro_toggle('k',handle(parent))
end event
