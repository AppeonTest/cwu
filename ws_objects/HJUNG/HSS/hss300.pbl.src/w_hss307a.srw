$PBExportHeader$w_hss307a.srw
$PBExportComments$난방시설운영관리
forward
global type w_hss307a from w_msheet
end type
type em_to_date from editmask within w_hss307a
end type
type st_2 from statictext within w_hss307a
end type
type em_fr_date from editmask within w_hss307a
end type
type st_1 from statictext within w_hss307a
end type
type tab_1 from tab within w_hss307a
end type
...
type uo_1 from u_tab within w_hss307a
end type
type gb_2 from groupbox within w_hss307a
end type
end forward
...
this.Control[iCurrent+1]=this.em_to_date
...
tab_1.tabpage_2.dw_print.object.DataWindow.Zoom = 90
...
IF ls_buil_no = '002' THEN
	tab_1.tabpage_1.dw_main.object.ton_cnt[tab_1.tabpage_1.dw_main.getrow()] = '1 TON'
	tab_1.tabpage_1.dw_main.object.tank_amount[tab_1.tabpage_1.dw_main.getrow()]= '19,700 LIT'
END IF
IF ls_buil_no = '003' THEN
	tab_1.tabpage_1.dw_main.object.ton_cnt[tab_1.tabpage_1.dw_main.getrow()] = '0.5,1 TON'
	tab_1.tabpage_1.dw_main.object.tank_amount[tab_1.tabpage_1.dw_main.getrow()]= '3,500 LIT'
END IF
IF ls_buil_no = '004' THEN
	tab_1.tabpage_1.dw_main.object.ton_cnt[tab_1.tabpage_1.dw_main.getrow()] = '0.3,1 TON'
	tab_1.tabpage_1.dw_main.object.tank_amount[tab_1.tabpage_1.dw_main.getrow()]= '2,906 LIT'
END IF
IF ls_buil_no = '005' THEN
	tab_1.tabpage_1.dw_main.object.ton_cnt[tab_1.tabpage_1.dw_main.getrow()] = '0.5,0.6 TON'
	tab_1.tabpage_1.dw_main.object.tank_amount[tab_1.tabpage_1.dw_main.getrow()]= '11,000 LIT'
END IF
IF ls_buil_no = '006' THEN
	tab_1.tabpage_1.dw_main.object.ton_cnt[tab_1.tabpage_1.dw_main.getrow()] = '0.3,0.8 TON'
	tab_1.tabpage_1.dw_main.object.tank_amount[tab_1.tabpage_1.dw_main.getrow()]= '10,000 LIT'
END IF
IF ls_buil_no = '007' THEN
	tab_1.tabpage_1.dw_main.object.ton_cnt[tab_1.tabpage_1.dw_main.getrow()] = '1,1 TON'
	tab_1.tabpage_1.dw_main.object.tank_amount[tab_1.tabpage_1.dw_main.getrow()]= '18,000 LIT'
END IF
...
ls_NotNullCol[2] = 'oper_date/운영일자'
...
IF li_check <> 0 THEN ls_str_date = trim(tab_1.tabpage_1.dw_main.object.oper_date[li_check])
If isnull(ls_str_date) or ls_str_date = '' then
 else
   if isdate(String(ls_str_date,'@@@@/@@/@@')) then
    else
	   MessageBox('확인','운영일자가 잘못 되었습니다.~r' +ls_str_date+ '의 일자를 확인 하여 주십시요.')
	   return -1
   end IF
end IF
...
//ll_RowCnt = tab_1.tabpage_1.dw_main.Retrieve(ls_buil_code,ls_fr_date, ls_to_date)
...
avc_data.SetProperty('title', "난방시설운영 리스트")
...
type ln_templeft from w_msheet`ln_templeft within w_hss307a
end type

type ln_tempright from w_msheet`ln_tempright within w_hss307a
end type

type ln_temptop from w_msheet`ln_temptop within w_hss307a
end type

type ln_tempbuttom from w_msheet`ln_tempbuttom within w_hss307a
end type

type ln_tempbutton from w_msheet`ln_tempbutton within w_hss307a
end type

type ln_tempstart from w_msheet`ln_tempstart within w_hss307a
end type

type uc_retrieve from w_msheet`uc_retrieve within w_hss307a
end type

type uc_insert from w_msheet`uc_insert within w_hss307a
end type

type uc_delete from w_msheet`uc_delete within w_hss307a
end type

type uc_save from w_msheet`uc_save within w_hss307a
end type

type uc_excel from w_msheet`uc_excel within w_hss307a
end type

type uc_print from w_msheet`uc_print within w_hss307a
end type

type st_line1 from w_msheet`st_line1 within w_hss307a
...
type st_line2 from w_msheet`st_line2 within w_hss307a
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
string facename = "Tahoma"
...
type st_line3 from w_msheet`st_line3 within w_hss307a
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
string facename = "Tahoma"
...
type uc_excelroad from w_msheet`uc_excelroad within w_hss307a
end type

type ln_dwcon from w_msheet`ln_dwcon within w_hss307a
end type
