$PBExportHeader$w_hin261i.srw
$PBExportComments$인사발령등록//교무처
forward
global type w_hin261i from w_msheet
end type
type dw_list from cuo_dwwindow_one_hin within w_hin261i
end type
type dw_con from uo_dwfree within w_hin261i
end type
type uo_member from cuo_insa_member within w_hin261i
end type
type dw_update from uo_dwfree within w_hin261i
end type
end forward
...
//ddlb_gubn.Text = "1. 교원"
dw_con.object.gubn[1] = '1'//ddlb_gubn.item[1] = "1. 교원"]
...
type ln_templeft from w_msheet`ln_templeft within w_hin261i
end type

type ln_tempright from w_msheet`ln_tempright within w_hin261i
end type

type ln_temptop from w_msheet`ln_temptop within w_hin261i
end type

type ln_tempbuttom from w_msheet`ln_tempbuttom within w_hin261i
end type

type ln_tempbutton from w_msheet`ln_tempbutton within w_hin261i
end type

type ln_tempstart from w_msheet`ln_tempstart within w_hin261i
end type

type uc_retrieve from w_msheet`uc_retrieve within w_hin261i
end type

type uc_insert from w_msheet`uc_insert within w_hin261i
end type

type uc_delete from w_msheet`uc_delete within w_hin261i
end type

type uc_save from w_msheet`uc_save within w_hin261i
end type

type uc_excel from w_msheet`uc_excel within w_hin261i
end type

type uc_print from w_msheet`uc_print within w_hin261i
end type

type st_line1 from w_msheet`st_line1 within w_hin261i
end type

type st_line2 from w_msheet`st_line2 within w_hin261i
end type

type st_line3 from w_msheet`st_line3 within w_hin261i
end type

type uc_excelroad from w_msheet`uc_excelroad within w_hin261i
end type

type ln_dwcon from w_msheet`ln_dwcon within w_hin261i
end type
