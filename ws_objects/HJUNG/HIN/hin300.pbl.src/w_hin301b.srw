$PBExportHeader$w_hin301b.srw
$PBExportComments$정기승진 대상자생성
forward
global type w_hin301b from w_msheet
end type
type dw_list from cuo_dwwindow_one_hin within w_hin301b
end type
type tab_1 from tab within w_hin301b
end type
...
type dw_con from uo_dwfree within w_hin301b
end type
type uo_member from cuo_insa_member within w_hin301b
end type
type uo_2 from u_tab within w_hin301b
end type
type cb_create from uo_imgbtn within w_hin301b
end type
end forward

global type w_hin301b from w_msheet
string title = "정기승진 대상자생성"
...
ls_year = string(dw_con.object.year[1], 'yyyy')//ls_year = em_year.text

If is_JikJongCode = '1' Then
	ls_Date = dw_con.object.date[1]//MID(ddlb_date.Text,4)
Elseif is_JikJongCode = '2' Then
	ls_Date = dw_con.object.date1[1]//MID(ddlb_date.Text,4)
End If
...
ll_RowCnt = idw_update[1].Retrieve(is_JikJongCode,is_AnnounceDate,is_KName)
...
DO WHILE ll_Row > 0
	...
	AND		DUTY_DATE  = :is_AnnounceDate
	AND		SUBSTR(DUTY_CODE,1,1) IN (	DECODE(:is_JikJongCode,'1','1','4'),
													DECODE(:is_JikJongCode,'1','1','5')	);
...
type ln_templeft from w_msheet`ln_templeft within w_hin301b
end type

type ln_tempright from w_msheet`ln_tempright within w_hin301b
end type

type ln_temptop from w_msheet`ln_temptop within w_hin301b
end type

type ln_tempbuttom from w_msheet`ln_tempbuttom within w_hin301b
end type

type ln_tempbutton from w_msheet`ln_tempbutton within w_hin301b
end type

type ln_tempstart from w_msheet`ln_tempstart within w_hin301b
end type

type uc_retrieve from w_msheet`uc_retrieve within w_hin301b
end type

type uc_insert from w_msheet`uc_insert within w_hin301b
end type

type uc_delete from w_msheet`uc_delete within w_hin301b
end type

type uc_save from w_msheet`uc_save within w_hin301b
end type

type uc_excel from w_msheet`uc_excel within w_hin301b
end type

type uc_print from w_msheet`uc_print within w_hin301b
end type

type st_line1 from w_msheet`st_line1 within w_hin301b
...
type st_line2 from w_msheet`st_line2 within w_hin301b
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
string facename = "Tahoma"
...
type st_line3 from w_msheet`st_line3 within w_hin301b
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
string facename = "Tahoma"
...
type uc_excelroad from w_msheet`uc_excelroad within w_hin301b
end type

type ln_dwcon from w_msheet`ln_dwcon within w_hin301b
end type
...
Choose Case dwo.name
	Case 'gubn'
		If data = '1' Then
			This.object.date[row] = '0301'
		Else
			This.object.date1[row] ='0701'
		End If
End Choose
end event
