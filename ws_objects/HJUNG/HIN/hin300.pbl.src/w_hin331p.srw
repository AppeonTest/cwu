$PBExportHeader$w_hin331p.srw
$PBExportComments$정기승진 대상자출력
forward
global type w_hin331p from w_msheet
end type
type dw_con from uo_dwfree within w_hin331p
end type
type dw_print from uo_dwfree within w_hin331p
end type
end forward
...
ls_Year = string(dw_con.object.year[1], 'yyyy')//TRIM(em_year.text)
...
dw_print.Object.t_jikjong_code.Text  =  dw_con.describe("Evaluate ('LookUpDisplay (gubn)', " + string(1) + ")")//dw_con.object.gubn[1] // MID(ddlb_gubn.Text,4)
...
avc_data.SetProperty('title', "정기승진현황")
...
type ln_templeft from w_msheet`ln_templeft within w_hin331p
end type

type ln_tempright from w_msheet`ln_tempright within w_hin331p
end type

type ln_temptop from w_msheet`ln_temptop within w_hin331p
end type

type ln_tempbuttom from w_msheet`ln_tempbuttom within w_hin331p
end type

type ln_tempbutton from w_msheet`ln_tempbutton within w_hin331p
end type

type ln_tempstart from w_msheet`ln_tempstart within w_hin331p
end type

type uc_retrieve from w_msheet`uc_retrieve within w_hin331p
end type

type uc_insert from w_msheet`uc_insert within w_hin331p
end type

type uc_delete from w_msheet`uc_delete within w_hin331p
end type

type uc_save from w_msheet`uc_save within w_hin331p
end type

type uc_excel from w_msheet`uc_excel within w_hin331p
end type

type uc_print from w_msheet`uc_print within w_hin331p
end type

type st_line1 from w_msheet`st_line1 within w_hin331p
end type

type st_line2 from w_msheet`st_line2 within w_hin331p
end type

type st_line3 from w_msheet`st_line3 within w_hin331p
end type

type uc_excelroad from w_msheet`uc_excelroad within w_hin331p
end type

type ln_dwcon from w_msheet`ln_dwcon within w_hin331p
end type
