$PBExportHeader$w_hin813p.srw
$PBExportComments$전체강의중시간강사가차지하는비율
forward
global type w_hin813p from w_msheet
end type
type dw_print from cuo_dwwindow within w_hin813p
end type
type em_yy from editmask within w_hin813p
end type
type st_1 from statictext within w_hin813p
end type
type gb_1 from groupbox within w_hin813p
end type
end forward

global type w_hin813p from w_msheet
string title = "전체강의중시간강사가차지하는비율"
...
type ln_templeft from w_msheet`ln_templeft within w_hin813p
end type

type ln_tempright from w_msheet`ln_tempright within w_hin813p
end type

type ln_temptop from w_msheet`ln_temptop within w_hin813p
end type

type ln_tempbuttom from w_msheet`ln_tempbuttom within w_hin813p
end type

type ln_tempbutton from w_msheet`ln_tempbutton within w_hin813p
end type

type ln_tempstart from w_msheet`ln_tempstart within w_hin813p
end type

type uc_retrieve from w_msheet`uc_retrieve within w_hin813p
end type

type uc_insert from w_msheet`uc_insert within w_hin813p
end type

type uc_delete from w_msheet`uc_delete within w_hin813p
end type

type uc_save from w_msheet`uc_save within w_hin813p
end type

type uc_excel from w_msheet`uc_excel within w_hin813p
end type

type uc_print from w_msheet`uc_print within w_hin813p
end type

type st_line1 from w_msheet`st_line1 within w_hin813p
end type

type st_line2 from w_msheet`st_line2 within w_hin813p
end type

type st_line3 from w_msheet`st_line3 within w_hin813p
end type

type uc_excelroad from w_msheet`uc_excelroad within w_hin813p
end type

type ln_dwcon from w_msheet`ln_dwcon within w_hin813p
end type
