$PBExportHeader$w_hin803p.srw
$PBExportComments$학과부(명) 교원명단
forward
global type w_hin803p from w_msheet
end type
type dw_print from cuo_dwwindow within w_hin803p
end type
type em_yy from editmask within w_hin803p
end type
type st_1 from statictext within w_hin803p
end type
type gb_1 from groupbox within w_hin803p
end type
end forward
