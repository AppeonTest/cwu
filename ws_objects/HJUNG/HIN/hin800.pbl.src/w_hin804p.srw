$PBExportHeader$w_hin804p.srw
$PBExportComments$외국인 교원 현황
forward
global type w_hin804p from w_msheet
end type
type dw_print from cuo_dwwindow within w_hin804p
end type
end forward
...
on w_hin804p.destroy
call super::destroy
destroy(this.dw_print)
end on

event ue_open;call super::ue_open;//////////////////////////////////////////////////////////////////////////////////////////
//	작성목적 : 외국인 교원 현황을 출력한다.
//	작 성 인 : 전희열
//	작성일자 : 2002.03
//	변 경 인 : 
//	변경일자 : 
