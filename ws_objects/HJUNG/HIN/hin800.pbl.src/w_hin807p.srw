$PBExportHeader$w_hin807p.srw
$PBExportComments$최근 5년간 교수채용 현황
forward
global type w_hin807p from w_msheet
end type
type dw_print from cuo_dwwindow within w_hin807p
end type
end forward
...
on w_hin807p.destroy
call super::destroy
destroy(this.dw_print)
end on

event ue_open;call super::ue_open;//////////////////////////////////////////////////////////////////////////////////////////
//	작성목적 : 최근 5년간 교수채용 현황을 출력한다.
//	작 성 인 : 전희열
//	작성일자 : 2002.03
//	변 경 인 : 
//	변경일자 : 
