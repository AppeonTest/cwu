$PBExportHeader$w_hin811p.srw
$PBExportComments$시간강사 현황
forward
global type w_hin811p from w_msheet
end type
type dw_print from cuo_dwwindow within w_hin811p
end type
type em_yy from editmask within w_hin811p
end type
type st_1 from statictext within w_hin811p
end type
type gb_1 from groupbox within w_hin811p
end type
end forward

global type w_hin811p from w_msheet
string title = "시간강사 현황"
