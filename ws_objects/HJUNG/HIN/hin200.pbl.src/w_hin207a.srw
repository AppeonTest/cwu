$PBExportHeader$w_hin207a.srw
$PBExportComments$직원평정평가관리
forward
global type w_hin207a from w_msheet
end type
type tab_1 from tab within w_hin207a
end type
...
type uo_1 from u_tab within w_hin207a
end type
type dw_con from uo_dwfree within w_hin207a
end type
end forward
...
type ln_templeft from w_msheet`ln_templeft within w_hin207a
end type

type ln_tempright from w_msheet`ln_tempright within w_hin207a
end type

type ln_temptop from w_msheet`ln_temptop within w_hin207a
end type

type ln_tempbuttom from w_msheet`ln_tempbuttom within w_hin207a
end type

type ln_tempbutton from w_msheet`ln_tempbutton within w_hin207a
end type

type ln_tempstart from w_msheet`ln_tempstart within w_hin207a
end type

type uc_retrieve from w_msheet`uc_retrieve within w_hin207a
end type

type uc_insert from w_msheet`uc_insert within w_hin207a
end type

type uc_delete from w_msheet`uc_delete within w_hin207a
end type

type uc_save from w_msheet`uc_save within w_hin207a
end type

type uc_excel from w_msheet`uc_excel within w_hin207a
end type

type uc_print from w_msheet`uc_print within w_hin207a
end type

type st_line1 from w_msheet`st_line1 within w_hin207a
...
type st_line2 from w_msheet`st_line2 within w_hin207a
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
string facename = "Tahoma"
...
type st_line3 from w_msheet`st_line3 within w_hin207a
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
string facename = "Tahoma"
...
type uc_excelroad from w_msheet`uc_excelroad within w_hin207a
end type

type ln_dwcon from w_msheet`ln_dwcon within w_hin207a
end type
...
integer taborder = 41
boolean bringtotop = true
string dataobject = "d_hin207a_con"
boolean border = false
borderstyle borderstyle = stylebox!
end type
