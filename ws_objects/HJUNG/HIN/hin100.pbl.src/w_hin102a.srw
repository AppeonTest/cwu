$PBExportHeader$w_hin102a.srw
$PBExportComments$직급코드 등록/출력
forward
global type w_hin102a from w_msheet
end type
type tab_1 from tab within w_hin102a
end type
...
type uo_1 from u_tab within w_hin102a
end type
end forward

global type w_hin102a from w_msheet
string title = "직급코드등록/출력"
tab_1 tab_1
uo_1 uo_1
end type
global w_hin102a w_hin102a

type variables
DataWindowChild	idwc_JikJong
end variables
...
//// 1. 초기값처리
/////////////////////////////////////////////////////////////////////////////////////////
//// 1.1 등록용 - 직종코드 DDDW초기화
//////////////////////////////////////////////////////////////////////////////////////
//tab_1.tabpage_1.dw_update.GetChild('jikjong_code',idwc_JikJong)
//idwc_JikJong.SetTransObject(SQLCA)
//IF idwc_JikJong.Retrieve('jikjong_code',1) = 0 THEN
//	wf_setmsg('공통코드[직종]를 입력하시기 바랍니다.')
//	idwc_JikJong.InsertRow(0)
//END IF
//////////////////////////////////////////////////////////////////////////////////////
//// 1.2 출력용 - 직종코드 DDDW초리
//////////////////////////////////////////////////////////////////////////////////////
//DataWindowChild	ldwc_Temp
//tab_1.tabpage_2.dw_print.GetChild('jikjong_code',ldwc_Temp)
//ldwc_Temp.SetTransObject(SQLCA)
//IF ldwc_Temp.Retrieve('jikjong_code',1) = 0 THEN
//	wf_setmsg('공통코드[직종]를 입력하시기 바랍니다.')
//	ldwc_Temp.InsertRow(0)
//END IF
/////////////////////////////////////////////////////////////////////////////////////////
//// 1.1 등록용 - 집계코드 DDDW초기화
//////////////////////////////////////////////////////////////////////////////////////
//tab_1.tabpage_1.dw_update.GetChild('appoint_opt2',idwc_JikJong)
//idwc_JikJong.SetTransObject(SQLCA)
//IF idwc_JikJong.Retrieve('appoint_opt2',1) = 0 THEN
//	wf_setmsg('공통코드[집계]를 입력하시기 바랍니다.')
//	idwc_JikJong.InsertRow(0)
//END IF
//tab_1.tabpage_1.dw_update.GetChild('appoint_opt1',idwc_JikJong)
//idwc_JikJong.SetTransObject(SQLCA)
//IF idwc_JikJong.Retrieve('appoint_opt1',1) = 0 THEN
//	wf_setmsg('공통코드[집계]를 입력하시기 바랍니다.')
//	idwc_JikJong.InsertRow(0)
//END IF
//////////////////////////////////////////////////////////////////////////////////////
//// 1.2 출력용 - 집계코드 DDDW초기화
//////////////////////////////////////////////////////////////////////////////////////
//tab_1.tabpage_2.dw_print.GetChild('appoint_opt2',ldwc_Temp)
//ldwc_Temp.SetTransObject(SQLCA)
//IF ldwc_Temp.Retrieve('appoint_opt2',1) = 0 THEN
//	wf_setmsg('공통코드[집계]를 입력하시기 바랍니다.')
//	ldwc_Temp.InsertRow(0)
//END IF
//tab_1.tabpage_2.dw_print.GetChild('appoint_opt1',ldwc_Temp)
//ldwc_Temp.SetTransObject(SQLCA)
//IF ldwc_Temp.Retrieve('appoint_opt1',1) = 0 THEN
//	wf_setmsg('공통코드[집계]를 입력하시기 바랍니다.')
//	ldwc_Temp.InsertRow(0)
//END IF
//
...
//			사용하지 안을경우는 커맨트 처리
///////////////////////////////////////////////////////////////////////////////////////
tab_1.tabpage_1.dw_update.Object.appoint_opt1[ll_InsRow] = 1
tab_1.tabpage_1.dw_update.Object.appoint_opt2[ll_InsRow] = 1
...
tab_1.tabpage_1.dw_update.SetColumn('jikjong_code')
...
ls_NotNullCol[1] = 'jikjong_code/직종코드'
ls_NotNullCol[2] = 'com_duty_seq/직급순번'
ls_NotNullCol[3] = 'duty_code/직급코드'
ls_NotNullCol[4] = 'duty_name/직급명'
...
avc_data.SetProperty('title', "직급코드리스트")
...
type ln_templeft from w_msheet`ln_templeft within w_hin102a
end type

type ln_tempright from w_msheet`ln_tempright within w_hin102a
end type

type ln_temptop from w_msheet`ln_temptop within w_hin102a
end type

type ln_tempbuttom from w_msheet`ln_tempbuttom within w_hin102a
end type

type ln_tempbutton from w_msheet`ln_tempbutton within w_hin102a
end type

type ln_tempstart from w_msheet`ln_tempstart within w_hin102a
end type

type uc_retrieve from w_msheet`uc_retrieve within w_hin102a
end type

type uc_insert from w_msheet`uc_insert within w_hin102a
end type

type uc_delete from w_msheet`uc_delete within w_hin102a
end type

type uc_save from w_msheet`uc_save within w_hin102a
end type

type uc_excel from w_msheet`uc_excel within w_hin102a
end type

type uc_print from w_msheet`uc_print within w_hin102a
end type

type st_line1 from w_msheet`st_line1 within w_hin102a
end type

type st_line2 from w_msheet`st_line2 within w_hin102a
end type

type st_line3 from w_msheet`st_line3 within w_hin102a
end type

type uc_excelroad from w_msheet`uc_excelroad within w_hin102a
end type

type ln_dwcon from w_msheet`ln_dwcon within w_hin102a
end type
...
CHOOSE CASE ls_ColName
	CASE 'com_duty_seq'
		...
		IF isNull(ls_JikJongCode) OR LEN(ls_JikJongCode) = 0 THEN
			...
			RETURN -1
		END IF
		MessageBox('ls_JikJongCode',ls_JikJongCode)
		MessageBox('ls_ColData',ls_ColData)
		//직급코드
