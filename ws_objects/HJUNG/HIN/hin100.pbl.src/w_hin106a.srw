$PBExportHeader$w_hin106a.srw
$PBExportComments$호봉코드관리(연봉직)
forward
global type w_hin106a from w_msheet
end type
type tab_1 from tab within w_hin106a
end type
...
type dw_con from uo_dwfree within w_hin106a
end type
type uo_1 from u_tab within w_hin106a
end type
end forward

global type w_hin106a from w_msheet
string title = "호봉코드관리(연봉직)"
long backcolor = 1073741824
tab_1 tab_1
dw_con dw_con
uo_1 uo_1
end type
global w_hin106a w_hin106a
...
//////////////////////////////////////////////////////////////////////////////////////
//tab_1.tabpage_1.dw_update.GetChild('com_sal_no',ldwc_Temp)
//ldwc_Temp.SetTransObject(SQLCA)
//IF ldwc_Temp.Retrieve('jikjong_code',0) = 0 THEN
//	wf_setmsg('공통코드[직종]를 입력하시기 바랍니다.')
//	ldwc_Temp.InsertRow(0)
...
//// 1.4 출력용 - 직종코드 DDDW초리
//////////////////////////////////////////////////////////////////////////////////////
//tab_1.tabpage_2.dw_print.GetChild('com_sal_no',ldwc_Temp)
//ldwc_Temp.SetTransObject(SQLCA)
...
//	ls_DutyNm   = tab_1.tabpage_1.dw_update.Object.Describe("Evaluate('LookUpDisplay(duty_code)'," + String(ll_GetRow) + ")")	//직급명
//				'   직급명 : ' + ls_DutyNm + '~r~n' + &
...
tab_1.tabpage_1.dw_update.Object.duty_code [ll_InsRow] = '801'
tab_1.tabpage_1.dw_update.Object.com_sal_no[ll_InsRow] = ls_JikJongCode
...
tab_1.tabpage_1.dw_update.SetColumn('com_sal_seq')
//////////////////////////////////////////////////////////////////////////////////////////
//	END OF SCRIPT
//////////////////////////////////////////////////////////////////////////////////////////
end event
...
avc_data.SetProperty('title', "호봉코드 리스트")
...
type ln_templeft from w_msheet`ln_templeft within w_hin106a
end type

type ln_tempright from w_msheet`ln_tempright within w_hin106a
end type

type ln_temptop from w_msheet`ln_temptop within w_hin106a
end type

type ln_tempbuttom from w_msheet`ln_tempbuttom within w_hin106a
end type

type ln_tempbutton from w_msheet`ln_tempbutton within w_hin106a
end type

type ln_tempstart from w_msheet`ln_tempstart within w_hin106a
end type

type uc_retrieve from w_msheet`uc_retrieve within w_hin106a
end type

type uc_insert from w_msheet`uc_insert within w_hin106a
end type

type uc_delete from w_msheet`uc_delete within w_hin106a
end type

type uc_save from w_msheet`uc_save within w_hin106a
end type

type uc_excel from w_msheet`uc_excel within w_hin106a
end type

type uc_print from w_msheet`uc_print within w_hin106a
end type

type st_line1 from w_msheet`st_line1 within w_hin106a
...
type st_line2 from w_msheet`st_line2 within w_hin106a
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
string facename = "Tahoma"
...
type st_line3 from w_msheet`st_line3 within w_hin106a
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
string facename = "Tahoma"
...
type uc_excelroad from w_msheet`uc_excelroad within w_hin106a
end type

type ln_dwcon from w_msheet`ln_dwcon within w_hin106a
...
CHOOSE CASE ls_ColName
	CASE 'com_sal_seq'
		...
		//	호봉순번 변경시 호봉코드 처리
		//		직급코드 = 기타직('901')
		//		호봉코드 = 직종코드(1자리) + 호봉순번(2자리)
		///////////////////////////////////////////////////////////////////////////////// 
		IF isNull(ls_ColData) OR LEN(ls_ColData) = 0 THEN
			THIS.Object.sal_class[row] = ls_Null
			RETURN
		END IF
		
		String	ls_JikJongCode	//직종코드
		ls_JikJongCode = TRIM(THIS.Object.com_sal_no[row])
		...
		//호봉코드
		THIS.Object.sal_class[row] = ls_JikJongCode + ls_ColData
