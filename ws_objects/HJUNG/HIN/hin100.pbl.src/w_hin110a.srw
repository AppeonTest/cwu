$PBExportHeader$w_hin110a.srw
$PBExportComments$정년사항 등록/출력
forward
global type w_hin110a from w_msheet
end type
type tab_1 from tab within w_hin110a
end type
...
type uo_1 from u_tab within w_hin110a
end type
end forward

global type w_hin110a from w_msheet
integer height = 2616
string title = "정년사항 등록/출력"
tab_1 tab_1
uo_1 uo_1
end type
global w_hin110a w_hin110a
...
DO WHILE ll_Row > 0
	...
	li_RetireAge   = tab_1.tabpage_1.dw_update.Object.hin025m_retire_age  [ll_Row]	//정년나이
	
	INSERT	INTO	INDB.HIN025M
...
type ln_templeft from w_msheet`ln_templeft within w_hin110a
end type

type ln_tempright from w_msheet`ln_tempright within w_hin110a
end type

type ln_temptop from w_msheet`ln_temptop within w_hin110a
end type

type ln_tempbuttom from w_msheet`ln_tempbuttom within w_hin110a
end type

type ln_tempbutton from w_msheet`ln_tempbutton within w_hin110a
end type

type ln_tempstart from w_msheet`ln_tempstart within w_hin110a
end type

type uc_retrieve from w_msheet`uc_retrieve within w_hin110a
end type

type uc_insert from w_msheet`uc_insert within w_hin110a
end type

type uc_delete from w_msheet`uc_delete within w_hin110a
end type

type uc_save from w_msheet`uc_save within w_hin110a
end type

type uc_excel from w_msheet`uc_excel within w_hin110a
end type

type uc_print from w_msheet`uc_print within w_hin110a
end type

type st_line1 from w_msheet`st_line1 within w_hin110a
...
type st_line2 from w_msheet`st_line2 within w_hin110a
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
string facename = "Tahoma"
...
type st_line3 from w_msheet`st_line3 within w_hin110a
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
string facename = "Tahoma"
...
type uc_excelroad from w_msheet`uc_excelroad within w_hin110a
end type

type ln_dwcon from w_msheet`ln_dwcon within w_hin110a
end type
