$PBExportHeader$w_hyd209a.srw
$PBExportComments$[w_list_master] 학술활동실적등록
forward
global type w_hyd209a from w_window
end type
type dw_list from uo_grid within w_hyd209a
end type
type dw_con from uo_dw within w_hyd209a
end type
type dw_main from uo_dw within w_hyd209a
end type
type p_1 from picture within w_hyd209a
end type
type st_main from statictext within w_hyd209a
end type
type p_2 from picture within w_hyd209a
end type
type st_detail from statictext within w_hyd209a
end type
type uo_app from uo_imgbtn within w_hyd209a
end type
end forward
...
lvc_data.setProperty('column1', 'cfrc_dvs_cd')  //학술대회구분
lvc_data.setProperty('key1', 'HYD1140')
lvc_data.setProperty('column2', 'cfrc_hctr_cd')  //학술대회개최국
lvc_data.setProperty('key2', 'HYD2000')
lvc_data.setProperty('column3', 'athr_dvs_cd')  //저자구분
lvc_data.setProperty('key3', 'HYD1180')
lvc_data.setProperty('column4', 'rsrchacps_stdy_sphe_cd')  //연구실적 학문분야
lvc_data.setProperty('key4', 'HYD2040')
lvc_data.setProperty('column5', 'appr_dvs_cd')  //승인구분
lvc_data.setProperty('key5', 'HYD1400')
...
type ln_templeft from w_window`ln_templeft within w_hyd209a
end type

type ln_tempright from w_window`ln_tempright within w_hyd209a
end type

type ln_temptop from w_window`ln_temptop within w_hyd209a
end type

type ln_tempbuttom from w_window`ln_tempbuttom within w_hyd209a
end type

type ln_tempbutton from w_window`ln_tempbutton within w_hyd209a
end type

type ln_tempstart from w_window`ln_tempstart within w_hyd209a
end type

type uc_retrieve from w_window`uc_retrieve within w_hyd209a
end type

type uc_insert from w_window`uc_insert within w_hyd209a
end type

type uc_delete from w_window`uc_delete within w_hyd209a
end type

type uc_save from w_window`uc_save within w_hyd209a
end type

type uc_excel from w_window`uc_excel within w_hyd209a
end type

type uc_print from w_window`uc_print within w_hyd209a
end type

type st_line1 from w_window`st_line1 within w_hyd209a
end type

type st_line2 from w_window`st_line2 within w_hyd209a
end type

type st_line3 from w_window`st_line3 within w_hyd209a
end type

type uc_excelroad from w_window`uc_excelroad within w_hyd209a
end type
...
integer taborder = 40
boolean bringtotop = true
string btnname = "국내외학술회의비신청"
end type

event clicked;call super::clicked;Vector	lvc_data
String ls_std_ym, ls_member_no, ls_mng_no, ls_cfrc_dvs_cd
