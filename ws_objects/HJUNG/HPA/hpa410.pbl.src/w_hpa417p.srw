$PBExportHeader$w_hpa417p.srw
$PBExportComments$근로소득영수증연간합계표
forward
global type w_hpa417p from w_print_form2
end type
type uo_year from cuo_year within w_hpa417p
end type
type st_71 from st_1 within w_hpa417p
end type
type st_81 from st_2 within w_hpa417p
end type
type st_4 from st_2 within w_hpa417p
end type
type uo_member_no from cuo_member_fromto within w_hpa417p
end type
type rb_all from radiobutton within w_hpa417p
end type
type rb_curr from radiobutton within w_hpa417p
end type
type rb_reti from radiobutton within w_hpa417p
end type
end forward
...
type ln_templeft from w_print_form2`ln_templeft within w_hpa417p
end type

type ln_tempright from w_print_form2`ln_tempright within w_hpa417p
end type

type ln_temptop from w_print_form2`ln_temptop within w_hpa417p
end type

type ln_tempbuttom from w_print_form2`ln_tempbuttom within w_hpa417p
end type

type ln_tempbutton from w_print_form2`ln_tempbutton within w_hpa417p
end type

type ln_tempstart from w_print_form2`ln_tempstart within w_hpa417p
end type

type uc_retrieve from w_print_form2`uc_retrieve within w_hpa417p
end type

type uc_insert from w_print_form2`uc_insert within w_hpa417p
end type

type uc_delete from w_print_form2`uc_delete within w_hpa417p
end type

type uc_save from w_print_form2`uc_save within w_hpa417p
end type

type uc_excel from w_print_form2`uc_excel within w_hpa417p
end type

type uc_print from w_print_form2`uc_print within w_hpa417p
end type

type st_line1 from w_print_form2`st_line1 within w_hpa417p
end type

type st_line2 from w_print_form2`st_line2 within w_hpa417p
end type

type st_line3 from w_print_form2`st_line3 within w_hpa417p
end type

type uc_excelroad from w_print_form2`uc_excelroad within w_hpa417p
end type

type ln_dwcon from w_print_form2`ln_dwcon within w_hpa417p
end type

type st_back from w_print_form2`st_back within w_hpa417p
integer y = 192
integer height = 2328
end type

type dw_print from w_print_form2`dw_print within w_hpa417p
integer y = 192
integer height = 2328
integer taborder = 60
string dataobject = "d_hpa417p_1"
end type

type st_1 from w_print_form2`st_1 within w_hpa417p
boolean visible = false
end type

type dw_head from w_print_form2`dw_head within w_hpa417p
boolean visible = false
end type
...
type uo_yearmonth from w_print_form2`uo_yearmonth within w_hpa417p
boolean visible = false
integer y = 144
end type

type uo_dept_code from w_print_form2`uo_dept_code within w_hpa417p
boolean visible = false
end type
...
type st_2 from w_print_form2`st_2 within w_hpa417p
integer x = 2871
end type

type st_3 from w_print_form2`st_3 within w_hpa417p
integer x = 2871
end type

type st_con from w_print_form2`st_con within w_hpa417p
end type

type dw_con from w_print_form2`dw_con within w_hpa417p
end type
