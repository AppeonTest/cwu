$PBExportHeader$w_hpa512i.srw
$PBExportComments$인사기본정보관리
forward
global type w_hpa512i from w_msheet
end type
type tab_1 from tab within w_hpa512i
end type
...
type dw_con from uo_dwfree within w_hpa512i
end type
type dw_list1 from cuo_dwwindow_one_hin within w_hpa512i
end type
type uo_member from cuo_insa_member within w_hpa512i
end type
type uo_2 from uo_imgbtn within w_hpa512i
end type
type uo_1 from u_tab within w_hpa512i
end type
type uo_3 from uo_imgbtn within w_hpa512i
end type
end forward
...
ls_DeptCode = TRIM(dw_con.Object.dept_cd[1])
...
////////////////////////////////////////////////////////////////////////////////////
String	ls_JaejikOpt
ls_JaejikOpt = TRIM(String(dw_con.Object.jaejik_opt[1]))
...
ls_JikJongCode = dw_con.Object.jikjong_code[1]
...
////////////////////////////////////////////////////////////////////////////////////
String     ls_cbx_chk
ls_cbx_chk = dw_con.Object.cbx_chk[1]
IF ls_cbx_chk = 'Y' THEN
...
FOR li_Arr = 1 TO UpperBound(li_ChgDw)
	...
	DO WHILE ll_Row > 0
		...
		CHOOSE CASE li_idx
			CASE 1	//인사상세정보
				IF ldis_Status = New! OR ldis_Status = NewModified! AND ls_cbx_chk = 'Y' THEN
					CHOOSE CASE UPPER(SQLCA.ServerName)
						CASE 'CWU'
							//////////////////////////////////////////////////////////////////
							// 3.1.1 개인번호 처리
							//			개인번호 = 전임: A 겸임;B 외래:D 강의전담:C 조교:E 직원:F + 일련번호(3)
							//////////////////////////////////////////////////////////////////
							...
							IF lb_Start THEN
								...
								SELECT DECODE( :ls_dutycode, '101','A','102','A','103','A','104','A',
	   			 			'111','B','112','C','121','D','301','D','131','E','F')||TRIM(TO_CHAR(NVL(MAX(TO_NUMBER(SUBSTR(MEMBER_NO,2,4)))+1,1),'0000'))
								INTO	 :ls_MemberSeq
								FROM   INDB.HIN001M
								WHERE  MEMBER_NO LIKE 	DECODE( :ls_dutycode, '101','A','102','A','103','A','104','A',
	   			 				'111','B','112','C','121','D','301','D','131','E','F')||'%'	;	 
...
//**************** 2006.03.01 로그인 사용자 권한 부여	****************//
					...
					INSERT INTO cddb.kch002m (MEMBER_NO,      PASSWORD,       JOB_GBN)
					                 VALUES  (:ls_memberno,   sys.cryptit.encrypt(:ls_memberno, 'cwu'),   'Y') USING SQLCA ;

//**************** 2006.03.01 외래교수인 경우  프로그램 사용자 권한 부여	****************// 

					IF ls_DutyCode = '301' THEN
                  INSERT INTO cddb.kch403m (GROUP_ID,       MEMBER_NO)
                                   VALUES  ('Prof2',        :ls_memberno)  USING SQLCA ;
					END IF
//**************** 개인번호 자동생성 아닐때************************************************//
...
//		wf_SetMenuBtn('ISR')
	CASE ELSE
		...
		Long	ll_DeleteCnt
		Long	ll_DeleteRow[]
		ll_SelectRow = idw_update[li_SelectedTab].GetSelectedRow(0)
		IF ll_SelectRow = 0 THEN RETURN 
		DO WHILE ll_SelectRow > 0 
			ll_DeleteCnt++
			ll_DeleteRow[ll_DeleteCnt] = ll_SelectRow
			
			ll_SelectRow = idw_update[li_SelectedTab].GetSelectedRow(ll_SelectRow)
		LOOP
...
dw_con.GetChild('dept_cd',ldwc_Temp)
...
dw_con.Object.jikjong_code.Protect = 1
dw_con.Object.duty_code.Protect     = 1
...
idw_update[01].SetTransObject(sqlca)
idw_update[02].SetTransObject(sqlca)
wf_SetMsg('인사기본정보를 초기화 중입니다...')
////////////////////////////////////////////////////////////////////////////////////
// 1.1 성별코드 DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg(1,'공통코드[인사기본정보_성별구분]를 초기화 중입니다...','')
...
// 1.4 조직코드 DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg('인사기본정보_조직코드를 초기화 중입니다...')
...
// 1.2 국가코드 DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg('공통코드[인사기본정보_국가코드]를 초기화 중입니다...')
...
// 1.3 재직코드 DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg('공통코드[인사기본정보_재직구분]를 초기화 중입니다...')
...
// 1.5 직위구분 DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg('공통코드[인사기본정보_직위코드]를 초기화 중입니다...')
idw_update[01].GetChild('jikwi_code',ldwc_Temp)
ldwc_Temp.SetTransObject(SQLCA)
ldwc_Temp.SetFilter("code in (7)")
ldwc_Temp.Filter()
...
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg('공통코드[인사기본정보_직위코드]를 초기화 중입니다...')
idw_update[12].GetChild('jikwi_code',ldwc_Temp)
ldwc_Temp.SetTransObject(SQLCA)
IF ldwc_Temp.Retrieve('jikwi_code',0) = 0 THEN
	wf_setmsg('공통코드[직위]를 입력하시기 바랍니다.')
	ldwc_Temp.InsertRow(0)
...
// 1.6 직무구분 DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg('공통코드[인사기본정보_직무코드]를 초기화 중입니다...')
...
// 1.7 최상위보직구분 DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg(1,'인사기본정보_최상위보직코드를 초기화 중입니다...','')
...
// 1.8 보직구분 DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg('인사기본정보_보직코드를 초기화 중입니다...')
...
// 1.9 변동구분DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg('공통코드[인사기본정보_변동코드]를 초기화 중입니다...')
...
// 1.10 최종학력DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg('공통코드[인사기본정보_학력구분]를 초기화 중입니다...')
...
// 1.11 연봉DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg(1,'공통코드[인사기본정보_연봉구분]를 초기화 중입니다...','')
...
// 1.12 역종DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg('공통코드[인사기본정보_역종코드]를 초기화 중입니다...')
...
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg('공통코드[인사기본정보_역종코드]를 초기화 중입니다...')
idw_update[12].GetChild('military_kind',ldwc_Temp)
ldwc_Temp.SetTransObject(SQLCA)
IF ldwc_Temp.Retrieve('yukjong_code',0) = 0 THEN
	wf_setmsg('공통코드[역종]를 입력하시기 바랍니다.')
	ldwc_Temp.InsertRow(0)
...
// 1.13 군별DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg('공통코드[인사기본정보_군별코드]를 초기화 중입니다...')
...
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg('공통코드[인사기본정보_군별코드]를 초기화 중입니다...')
idw_update[12].GetChild('army_kind',ldwc_Temp)
ldwc_Temp.SetTransObject(SQLCA)
IF ldwc_Temp.Retrieve('isarmy_code',0) = 0 THEN
	wf_setmsg('공통코드[군별]를 입력하시기 바랍니다.')
	ldwc_Temp.InsertRow(0)
...
// 1.14 계급DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg('공통코드[인사기본정보_계급코드]를 초기화 중입니다...')
...
// 1.14 병과DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg('공통코드[인사기본정보_병과코드]를 초기화 중입니다...')
...
// 1.14 미필사유DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg('공통코드[인사기본정보_미필사유]를 초기화 중입니다...')
...
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg('공통코드[인사기본정보_미필사유]를 초기화 중입니다...')
idw_update[12].GetChild('none_remark',ldwc_Temp)
ldwc_Temp.SetTransObject(SQLCA)
IF ldwc_Temp.Retrieve('none_remark',0) = 0 THEN
	wf_setmsg('공통코드[미필사유]를 입력하시기 바랍니다.')
	ldwc_Temp.InsertRow(0)
...
// 1.14  체격등급DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg('공통코드[인사기본정보_체격등급]를 초기화 중입니다...')
...
// 1.14  체격등급DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg('공통코드[인사기본정보_체겨등급]를 초기화 중입니다...')
idw_update[12].GetChild('physical_grade',ldwc_Temp)
ldwc_Temp.SetTransObject(SQLCA)
IF ldwc_Temp.Retrieve('physical_grade',0) = 0 THEN
	wf_setmsg('공통코드[미필사유]를 입력하시기 바랍니다.')
	ldwc_Temp.InsertRow(0)
...
String	ls_SysDate
ls_SysDate = f_today()
//wf_setmsg('인사기본정보_호봉코드를 초기화 중입니다...')
idw_update[01].GetChild('sal_class',ldwc_Temp)
ldwc_Temp.SetTransObject(SQLCA)
IF ldwc_Temp.Retrieve(MID(ls_SysDate,1,4),'100') = 0 THEN
...
// 1.16 졸업구분 DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg('공통코드[인사기본정보_졸업구분]를 초기화 중입니다...')
...
// 2.1 종교 DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg('공통코드[신상상세정보_종교코드]를 초기화 중입니다...')
...
// 2.2 보훈구분 DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg(1,'공통코드[신상상세정보_보훈구분]를 초기화 중입니다...','')
...
// 2.3 장애구분 DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg(1,'공통코드[신상상세정보_장애구분]를 초기화 중입니다...','')
...
// 2.3 장애종류 DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg(1,'공통코드[신상상세정보_장애종류]를 초기화 중입니다...','')
...
// 2.4 관계 DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg(1,'공통코드[신상상세정보_관계구분]를 초기화 중입니다...','')
...
// 2.5 특기 DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg(1,'공통코드[신상상세정보_특기구분]를 초기화 중입니다...','')
...
// 2.6 취미 DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg(1,'공통코드[신상상세정보_취미구분]를 초기화 중입니다...','')
...
// 2.7 주거 DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg(1,'공통코드[신상상세정보_주거구분]를 초기화 중입니다...','')
...
// 2.8 은행 DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg(1,'신상상세정보_은행코드를 초기화 중입니다...','')
...
// 3.1 관계 DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg(1,'공통코드[가족사항_관계구분]를 초기화 중입니다...','')
...
// 3.1 부양구분 DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg(1,'공통코드[가족사항_부양구분]를 초기화 중입니다...','')
...
// 3.2 장애 DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg(1,'공통코드[가족사항_장애구분]를 초기화 중입니다...','')
...
// 4.1 학위취득국가DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg(1,'공통코드[학력사항_국적구분]를 초기화 중입니다...','')
...
// 4.2 최종학력DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg(1,'공통코드[학력사항_학력구분]를 초기화 중입니다...','')
...
// 4.3 졸업구분DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg(1,'공통코드[학력사항_졸업구분]를 초기화 중입니다...','')
...
// 5.1 경력구분 DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg(1,'공통코드[경력사항_]를 초기화 중입니다...','')
...
// 5.2 처리구분 DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg(1,'공통코드[경력사항_처리구분]를 초기화 중입니다...','')
...
// 7.1 상벌 DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg(1,'공통코드[포상징계사항_상벌]를 초기화 중입니다...','')
...
// 7.1 학과 DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg(1,'공통코드[학과]를 초기화 중입니다...','')
...
// 8.1 연수구분DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg(1,'공통코드[해외연수사항_연수구분]를 초기화 중입니다...','')
...
// 8.2 국가코드DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg(1,'공통코드[해외연수사항_국적구분]를 초기화 중입니다...','')
...
// 1.14 병과DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg(1,'공통코드[인사기본정보_병과코드]를 초기화 중입니다...','')
idw_update[12].GetChild('byungkwa',ldwc_Temp)
ldwc_Temp.SetTransObject(SQLCA)
IF ldwc_Temp.Retrieve('byungkwa',0) = 0 THEN
	wf_setmsg('공통코드[계급]를 입력하시기 바랍니다.')
	ldwc_Temp.InsertRow(0)
...
// 1.14 계급DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg(1,'공통코드[인사기본정보_계급코드]를 초기화 중입니다...','')
idw_update[12].GetChild('army_rank',ldwc_Temp)
ldwc_Temp.SetTransObject(SQLCA)
IF ldwc_Temp.Retrieve('gegub_code',0) = 0 THEN
	wf_setmsg('공통코드[계급]를 입력하시기 바랍니다.')
	ldwc_Temp.InsertRow(0)
...
// 1.14 주특기DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg(1,'공통코드[인사기본정보_미필사유]를 초기화 중입니다...','')
idw_update[12].GetChild('speciality',ldwc_Temp)
ldwc_Temp.SetTransObject(SQLCA)
IF ldwc_Temp.Retrieve('speciality',0) = 0 THEN
	wf_setmsg('공통코드[미필사유]를 입력하시기 바랍니다.')
	ldwc_Temp.InsertRow(0)
...
// 2.1 종교 DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg(1,'공통코드[신상상세정보_종교코드]를 초기화 중입니다...','')
idw_update[12].GetChild('jonggyo_code',ldwc_Temp)
ldwc_Temp.SetTransObject(SQLCA)
IF ldwc_Temp.Retrieve('jonggyo_code',0) = 0 THEN
	wf_setmsg('공통코드[종교]를 입력하시기 바랍니다.')
	ldwc_Temp.InsertRow(0)
...
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg(1,'공통코드[신상상세정보_특기구분]를 초기화 중입니다...','')
idw_update[12].GetChild('specialty',ldwc_Temp)
ldwc_Temp.SetTransObject(SQLCA)
IF ldwc_Temp.Retrieve('specialty_opt',0) = 0 THEN
	wf_setmsg('공통코드[특기]를 입력하시기 바랍니다.')
	ldwc_Temp.InsertRow(0)
...
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg(1,'공통코드[신상상세정보_주거구분]를 초기화 중입니다...','')
idw_update[12].GetChild('house_code',ldwc_Temp)
ldwc_Temp.SetTransObject(SQLCA)
IF ldwc_Temp.Retrieve('house_code',0) = 0 THEN
	wf_setmsg('공통코드[주거]를 입력하시기 바랍니다.')
	ldwc_Temp.InsertRow(0)
...
// 1.10 최종학력DDDW초기화
////////////////////////////////////////////////////////////////////////////////////
//wf_setmsg(1,'공통코드[인사기본정보_학력구분]를 초기화 중입니다...','')
idw_update[12].GetChild('last_school_code',ldwc_Temp)
ldwc_Temp.SetTransObject(SQLCA)
IF ldwc_Temp.Retrieve('last_school_code',0) = 0 THEN
	wf_setmsg('공통코드[학력]를 입력하시기 바랍니다.')
	ldwc_Temp.InsertRow(0)
...
type ln_templeft from w_msheet`ln_templeft within w_hpa512i
end type

type ln_tempright from w_msheet`ln_tempright within w_hpa512i
end type

type ln_temptop from w_msheet`ln_temptop within w_hpa512i
end type

type ln_tempbuttom from w_msheet`ln_tempbuttom within w_hpa512i
end type

type ln_tempbutton from w_msheet`ln_tempbutton within w_hpa512i
end type

type ln_tempstart from w_msheet`ln_tempstart within w_hpa512i
end type

type uc_retrieve from w_msheet`uc_retrieve within w_hpa512i
end type

type uc_insert from w_msheet`uc_insert within w_hpa512i
end type

type uc_delete from w_msheet`uc_delete within w_hpa512i
end type

type uc_save from w_msheet`uc_save within w_hpa512i
end type

type uc_excel from w_msheet`uc_excel within w_hpa512i
end type

type uc_print from w_msheet`uc_print within w_hpa512i
end type

type st_line1 from w_msheet`st_line1 within w_hpa512i
end type

type st_line2 from w_msheet`st_line2 within w_hpa512i
end type

type st_line3 from w_msheet`st_line3 within w_hpa512i
end type

type uc_excelroad from w_msheet`uc_excelroad within w_hpa512i
end type

type ln_dwcon from w_msheet`ln_dwcon within w_hpa512i
end type
...
integer height = 1240
integer taborder = 80
string dataobject = "d_hpa512i_02"
...
integer height = 1232
integer taborder = 80
string dataobject = "d_hpa512i_11"
boolean vscrollbar = true
end type
...
integer height = 1216
integer taborder = 11
string dataobject = "d_hpa512i_03"
end type
...
integer height = 1224
integer taborder = 11
string dataobject = "d_hpa512i_04"
end type
...
integer height = 1224
integer taborder = 11
string dataobject = "d_hpa512i_05_1"
end type
...
//			GOTO SUM_PROS
			...
			//변수 초기화
				...
				ll_RowCnt =li_Null
				ll_GetRow = li_Null
				ll_GetColumn = li_Null
				ls_Str = ls_null

				li_ProcesOpt = li_Null	
				ldc_CareerYm = li_Null	//근속인정년월누계
				ldc_CarYear = li_Null		//총경력년월누계
...
integer height = 1224
integer taborder = 11
string dataobject = "d_hpa512i_06"
end type
...
integer height = 1224
integer taborder = 11
string dataobject = "d_hpa512i_07"
end type
...
integer height = 1224
integer taborder = 21
string dataobject = "d_hpa512i_09"
end type
...
integer height = 1224
integer taborder = 11
string dataobject = "d_hpa512i_12"
end type
...
integer height = 1224
integer taborder = 11
string dataobject = "d_hpa512i_08"
end type
...
integer height = 1224
integer taborder = 11
string dataobject = "d_hpa512i_10"
end type
...
integer height = 1224
integer taborder = 11
string dataobject = "d_hpa512i_13"
boolean vscrollbar = true
...
integer height = 204
integer taborder = 60
string dataobject = "d_hpa512i_c1"
...
This.Object.jikjong_code[1] = String(li_JikJongCode)
...
integer height = 500
integer taborder = 70
string dataobject = "d_hpa512i_01"
boolean border = false
borderstyle borderstyle = stylebox!
end type
...
///////////////////////////////////////////////////////////////////////////////////////
Integer	li_Rtn
li_Rtn = Messagebox('확인','인사기본자료의 호봉년도를~r~n호봉코드의 최종년도('+&
								ls_SalYear+')로 변환하시겠습니까',StopSign!, YesNo!)
IF li_Rtn = 2 THEN
	wf_SetMsg('호봉년도 변경작업을 취소하셨습니다.')
	RETURN
END IF
...
integer taborder = 31
boolean bringtotop = true
string btnname = "고용보험 전체초기화"
end type

event clicked;call super::clicked;Int li_gubun
String ls_errtext

li_gubun = Messagebox('확인', '외래교수의 고용보험구분을 전체초기화하시겠습니까?', StopSign!, YesNo! )
