$PBExportHeader$w_hge502a.srw
$PBExportComments$책임시수 관리/출력
forward
global type w_hge502a from w_tabsheet
end type
...
type st_1 from statictext within w_hge502a
end type
type ddlb_gb from dropdownlistbox within w_hge502a
end type
type em_time from editmask within w_hge502a
end type
type em_limit_time from editmask within w_hge502a
end type
type st_2 from statictext within w_hge502a
end type
type st_3 from statictext within w_hge502a
end type
type st_4 from statictext within w_hge502a
end type
type st_5 from statictext within w_hge502a
end type
type pb_create from uo_imgbtn within w_hge502a
end type
type gb_1 from groupbox within w_hge502a
end type
end forward
...
this.Control[iCurrent+3]=this.em_time
this.Control[iCurrent+4]=this.em_limit_time
this.Control[iCurrent+5]=this.st_2
this.Control[iCurrent+6]=this.st_3
this.Control[iCurrent+7]=this.st_4
this.Control[iCurrent+8]=this.st_5
this.Control[iCurrent+9]=this.pb_create
this.Control[iCurrent+10]=this.gb_1
end on

on w_hge502a.destroy
call super::destroy
destroy(this.st_1)
...
type ln_templeft from w_tabsheet`ln_templeft within w_hge502a
end type

type ln_tempright from w_tabsheet`ln_tempright within w_hge502a
end type

type ln_temptop from w_tabsheet`ln_temptop within w_hge502a
end type

type ln_tempbuttom from w_tabsheet`ln_tempbuttom within w_hge502a
end type

type ln_tempbutton from w_tabsheet`ln_tempbutton within w_hge502a
end type

type ln_tempstart from w_tabsheet`ln_tempstart within w_hge502a
end type

type uc_retrieve from w_tabsheet`uc_retrieve within w_hge502a
end type

type uc_insert from w_tabsheet`uc_insert within w_hge502a
end type

type uc_delete from w_tabsheet`uc_delete within w_hge502a
end type

type uc_save from w_tabsheet`uc_save within w_hge502a
end type

type uc_excel from w_tabsheet`uc_excel within w_hge502a
end type

type uc_print from w_tabsheet`uc_print within w_hge502a
end type

type st_line1 from w_tabsheet`st_line1 within w_hge502a
end type

type st_line2 from w_tabsheet`st_line2 within w_hge502a
end type

type st_line3 from w_tabsheet`st_line3 within w_hge502a
end type

type uc_excelroad from w_tabsheet`uc_excelroad within w_hge502a
end type

type ln_dwcon from w_tabsheet`ln_dwcon within w_hge502a
end type

type tab_sheet from w_tabsheet`tab_sheet within w_hge502a
integer y = 356
integer width = 4384
integer height = 1920
integer textsize = -9
...
type uo_tab from w_tabsheet`uo_tab within w_hge502a
integer x = 1454
integer y = 308
long backcolor = 1073741824
end type

type dw_con from w_tabsheet`dw_con within w_hge502a
boolean visible = false
end type

type st_con from w_tabsheet`st_con within w_hge502a
boolean visible = false
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
...
if is_respons_gb = '1' then
	idw_code.dataobject	=	'd_hge502a_5'
	
	idw_data.dataobject	=	'd_hge502a_1'
	...
	idw_print.dataobject	=	'd_hge502a_3'
	...
	//messagebox('',is_respons_gb)
	idw_code.dataobject	=	'd_hge502a_6'
	idw_data.dataobject	=	'd_hge502a_2'
	idw_print.dataobject	=	'd_hge502a_4'
end if
