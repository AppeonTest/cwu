$PBExportHeader$w_hge509q.srw
$PBExportComments$이체 은행계좌 관리/출력
forward
global type w_hge509q from w_tabsheet
end type
...
type dw_head from datawindow within w_hge509q
end type
type st_1 from statictext within w_hge509q
end type
type rb_3 from radiobutton within w_hge509q
end type
type rb_4 from radiobutton within w_hge509q
end type
type rb_5 from radiobutton within w_hge509q
end type
type uo_gwa from cuo_dept within w_hge509q
end type
end forward
...
//		ist_back2.bringtotop = false
	else
//		ist_back2.bringtotop = true
	end if
...
type ln_templeft from w_tabsheet`ln_templeft within w_hge509q
end type

type ln_tempright from w_tabsheet`ln_tempright within w_hge509q
end type

type ln_temptop from w_tabsheet`ln_temptop within w_hge509q
end type

type ln_tempbuttom from w_tabsheet`ln_tempbuttom within w_hge509q
end type

type ln_tempbutton from w_tabsheet`ln_tempbutton within w_hge509q
end type

type ln_tempstart from w_tabsheet`ln_tempstart within w_hge509q
end type

type uc_retrieve from w_tabsheet`uc_retrieve within w_hge509q
end type

type uc_insert from w_tabsheet`uc_insert within w_hge509q
end type

type uc_delete from w_tabsheet`uc_delete within w_hge509q
end type

type uc_save from w_tabsheet`uc_save within w_hge509q
end type

type uc_excel from w_tabsheet`uc_excel within w_hge509q
end type

type uc_print from w_tabsheet`uc_print within w_hge509q
end type

type st_line1 from w_tabsheet`st_line1 within w_hge509q
end type

type st_line2 from w_tabsheet`st_line2 within w_hge509q
end type

type st_line3 from w_tabsheet`st_line3 within w_hge509q
end type

type uc_excelroad from w_tabsheet`uc_excelroad within w_hge509q
end type

type ln_dwcon from w_tabsheet`ln_dwcon within w_hge509q
end type

type tab_sheet from w_tabsheet`tab_sheet within w_hge509q
integer y = 324
integer width = 4384
integer height = 1956
integer textsize = -9
...
//	case else
//		//idw_print	=	tab_sheet.tabpage_sheet04.dw_print2
//		wf_setMenu('INSERT',		FALSE)
//		wf_setMenu('DELETE',		FALSE)
//		wf_setMenu('RETRIEVE',	TRUE)
//		wf_setMenu('UPDATE',		FALSE)
...
type uo_tab from w_tabsheet`uo_tab within w_hge509q
integer x = 1550
integer y = 300
long backcolor = 1073741824
end type

type dw_con from w_tabsheet`dw_con within w_hge509q
boolean visible = false
integer x = 4389
integer y = 244
integer width = 41
...
type st_con from w_tabsheet`st_con within w_hge509q
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
string facename = "Tahoma"
