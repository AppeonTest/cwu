$PBExportHeader$w_hpa510p.srw
$PBExportComments$년학기 강사료 지급 내역서 출력---old
forward
global type w_hpa510p from w_tabsheet
end type
...
type uo_yearhakgi from cuo_yyhakgi within w_hpa510p
end type
type rb_1 from radiobutton within w_hpa510p
end type
type rb_2 from radiobutton within w_hpa510p
end type
type rb_4 from radiobutton within w_hpa510p
end type
type uo_mm from cuo_month within w_hpa510p
end type
type rb_3 from radiobutton within w_hpa510p
end type
type rb_5 from radiobutton within w_hpa510p
end type
end forward
...
type ln_templeft from w_tabsheet`ln_templeft within w_hpa510p
end type

type ln_tempright from w_tabsheet`ln_tempright within w_hpa510p
end type

type ln_temptop from w_tabsheet`ln_temptop within w_hpa510p
end type

type ln_tempbuttom from w_tabsheet`ln_tempbuttom within w_hpa510p
end type

type ln_tempbutton from w_tabsheet`ln_tempbutton within w_hpa510p
end type

type ln_tempstart from w_tabsheet`ln_tempstart within w_hpa510p
end type

type uc_retrieve from w_tabsheet`uc_retrieve within w_hpa510p
end type

type uc_insert from w_tabsheet`uc_insert within w_hpa510p
end type

type uc_delete from w_tabsheet`uc_delete within w_hpa510p
end type

type uc_save from w_tabsheet`uc_save within w_hpa510p
end type

type uc_excel from w_tabsheet`uc_excel within w_hpa510p
end type

type uc_print from w_tabsheet`uc_print within w_hpa510p
end type

type st_line1 from w_tabsheet`st_line1 within w_hpa510p
end type

type st_line2 from w_tabsheet`st_line2 within w_hpa510p
end type

type st_line3 from w_tabsheet`st_line3 within w_hpa510p
end type

type uc_excelroad from w_tabsheet`uc_excelroad within w_hpa510p
end type

type ln_dwcon from w_tabsheet`ln_dwcon within w_hpa510p
end type

type tab_sheet from w_tabsheet`tab_sheet within w_hpa510p
integer y = 320
integer width = 4384
integer height = 1968
integer textsize = -9
...
type uo_tab from w_tabsheet`uo_tab within w_hpa510p
end type

type dw_con from w_tabsheet`dw_con within w_hpa510p
boolean visible = false
end type

type st_con from w_tabsheet`st_con within w_hpa510p
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
string facename = "Tahoma"
