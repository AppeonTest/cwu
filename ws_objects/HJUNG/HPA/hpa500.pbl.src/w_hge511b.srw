$PBExportHeader$w_hge511b.srw
$PBExportComments$강사료 기초자료 생성
forward
global type w_hge511b from w_msheet
end type
type dw_mast from datawindow within w_hge511b
end type
type dw_print from datawindow within w_hge511b
end type
type st_27 from statictext within w_hge511b
end type
type st_26 from statictext within w_hge511b
end type
type st_create_cnt2 from statictext within w_hge511b
end type
type st_err_cnt2 from statictext within w_hge511b
end type
type st_23 from statictext within w_hge511b
end type
type st_31 from statictext within w_hge511b
end type
type uo_end_week from cuo_week within w_hge511b
end type
type uo_str_week from cuo_week within w_hge511b
end type
type st_err_cnt1 from statictext within w_hge511b
end type
type st_create_cnt1 from statictext within w_hge511b
end type
type st_20 from statictext within w_hge511b
end type
type st_19 from statictext within w_hge511b
end type
type rb_3 from radiobutton within w_hge511b
end type
type rb_2 from radiobutton within w_hge511b
end type
type rb_1 from radiobutton within w_hge511b
end type
type uo_gwa from cuo_hakgwa within w_hge511b
end type
type gb_3 from groupbox within w_hge511b
end type
type st_24 from statictext within w_hge511b
end type
type st_25 from statictext within w_hge511b
end type
type gb_1 from groupbox within w_hge511b
end type
type st_28 from statictext within w_hge511b
end type
type st_29 from statictext within w_hge511b
end type
type gb_2 from groupbox within w_hge511b
end type
type dw_list002 from datawindow within w_hge511b
end type
type uo_insa from cuo_insa_member_gangsa within w_hge511b
end type
type uo_yy from cuo_yyhakgi within w_hge511b
end type
type st_1 from statictext within w_hge511b
end type
type st_2 from statictext within w_hge511b
end type
type pb_create from uo_imgbtn within w_hge511b
end type
type pb_delete from uo_imgbtn within w_hge511b
end type
type dw_list001 from uo_dwgrid within w_hge511b
end type
end forward
...
SELECT "GEDB"."HPA111M"."YEAR"  
  INTO :ll_cnt  
  FROM "GEDB"."HPA111M"  
 WHERE ( GEDB."HPA111M"."YEAR"      =		:is_yy ) AND  
       ( GEDB."HPA111M"."HAKGI"     =		:is_hakgi ) AND  
       ( GEDB."HPA111M"."MEMBER_NO" like	:is_member ) AND  
       ( GEDB."HPA111M"."GWA" like	:is_gwa )	;
...
for	ll_row = 1	to	ll_mast_count
	...
	// 책임시수를 구한다.
	SELECT	nvl("GEDB"."HPA201M"."RESPONS_TIME", 0),
				nvl("GEDB"."HPA201M"."LIMIT_TIME", 0)
	  INTO 	:ll_time, :ll_limit_time
	  FROM 	"GEDB"."HPA201M"
	 WHERE 	"GEDB"."HPA201M"."RESPONS_GB" 	= '1' AND
			 	"GEDB"."HPA201M"."RESPONS_CODE" 	= :ls_bojik;
	...
	if ll_time < 1 then
		SELECT	nvl("GEDB"."HPA201M"."RESPONS_TIME", 0),
		  ...
		  INTO	:ll_time, :ll_limit_time
	     FROM 	"GEDB"."HPA201M"  
		 WHERE 	"GEDB"."HPA201M"."RESPONS_GB" 	= '2' AND
		       	"GEDB"."HPA201M"."RESPONS_CODE" 	= :ls_duty;
...
this.Control[iCurrent+20]=this.st_24
this.Control[iCurrent+21]=this.st_25
this.Control[iCurrent+22]=this.gb_1
this.Control[iCurrent+23]=this.st_28
this.Control[iCurrent+24]=this.st_29
this.Control[iCurrent+25]=this.gb_2
this.Control[iCurrent+26]=this.dw_list002
this.Control[iCurrent+27]=this.uo_insa
this.Control[iCurrent+28]=this.uo_yy
this.Control[iCurrent+29]=this.st_1
this.Control[iCurrent+30]=this.st_2
this.Control[iCurrent+31]=this.pb_create
this.Control[iCurrent+32]=this.pb_delete
this.Control[iCurrent+33]=this.dw_list001
end on

on w_hge511b.destroy
call super::destroy
...
type ln_templeft from w_msheet`ln_templeft within w_hge511b
end type

type ln_tempright from w_msheet`ln_tempright within w_hge511b
end type

type ln_temptop from w_msheet`ln_temptop within w_hge511b
end type

type ln_tempbuttom from w_msheet`ln_tempbuttom within w_hge511b
end type

type ln_tempbutton from w_msheet`ln_tempbutton within w_hge511b
end type

type ln_tempstart from w_msheet`ln_tempstart within w_hge511b
end type

type uc_retrieve from w_msheet`uc_retrieve within w_hge511b
end type

type uc_insert from w_msheet`uc_insert within w_hge511b
end type

type uc_delete from w_msheet`uc_delete within w_hge511b
end type

type uc_save from w_msheet`uc_save within w_hge511b
end type

type uc_excel from w_msheet`uc_excel within w_hge511b
end type

type uc_print from w_msheet`uc_print within w_hge511b
end type

type st_line1 from w_msheet`st_line1 within w_hge511b
end type

type st_line2 from w_msheet`st_line2 within w_hge511b
end type

type st_line3 from w_msheet`st_line3 within w_hge511b
end type

type uc_excelroad from w_msheet`uc_excelroad within w_hge511b
end type

type ln_dwcon from w_msheet`ln_dwcon within w_hge511b
end type
...
elseif li_rtn	=	100	then
	...
	wf_setmsg('')
	f_messagebox('3', '삭제를 실패했습니다. 전산소에 문의하시기 바랍니다.!~n~n' + sqlca.sqlerrtext)
end if
