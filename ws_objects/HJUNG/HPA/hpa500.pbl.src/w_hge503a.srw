$PBExportHeader$w_hge503a.srw
$PBExportComments$[대학원]강사료 지급항목 관리/출력-신규
forward
global type w_hge503a from w_tabsheet
end type
...
type ln_templeft from w_tabsheet`ln_templeft within w_hge503a
end type

type ln_tempright from w_tabsheet`ln_tempright within w_hge503a
end type

type ln_temptop from w_tabsheet`ln_temptop within w_hge503a
end type

type ln_tempbuttom from w_tabsheet`ln_tempbuttom within w_hge503a
end type

type ln_tempbutton from w_tabsheet`ln_tempbutton within w_hge503a
end type

type ln_tempstart from w_tabsheet`ln_tempstart within w_hge503a
end type

type uc_retrieve from w_tabsheet`uc_retrieve within w_hge503a
end type

type uc_insert from w_tabsheet`uc_insert within w_hge503a
end type

type uc_delete from w_tabsheet`uc_delete within w_hge503a
end type

type uc_save from w_tabsheet`uc_save within w_hge503a
end type

type uc_excel from w_tabsheet`uc_excel within w_hge503a
end type

type uc_print from w_tabsheet`uc_print within w_hge503a
end type

type st_line1 from w_tabsheet`st_line1 within w_hge503a
...
type st_line2 from w_tabsheet`st_line2 within w_hge503a
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
string facename = "Tahoma"
...
type st_line3 from w_tabsheet`st_line3 within w_hge503a
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
string facename = "Tahoma"
...
type uc_excelroad from w_tabsheet`uc_excelroad within w_hge503a
end type

type ln_dwcon from w_tabsheet`ln_dwcon within w_hge503a
end type

type tab_sheet from w_tabsheet`tab_sheet within w_hge503a
integer y = 196
integer width = 4384
integer height = 2092
integer textsize = -9
...
type uo_tab from w_tabsheet`uo_tab within w_hge503a
integer x = 1362
integer y = 148
long backcolor = 1073741824
end type

type dw_con from w_tabsheet`dw_con within w_hge503a
boolean visible = false
integer x = 59
integer y = 8
end type

type st_con from w_tabsheet`st_con within w_hge503a
boolean visible = false
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
