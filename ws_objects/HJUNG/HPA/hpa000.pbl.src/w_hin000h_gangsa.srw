$PBExportHeader$w_hin000h_gangsa.srw
$PBExportComments$인사기본정보도움말(성명,개인번호)
forward
global type w_hin000h_gangsa from window
end type
type cb_retrieve from commandbutton within w_hin000h_gangsa
end type
type cb_cancel from commandbutton within w_hin000h_gangsa
end type
type cb_ok from commandbutton within w_hin000h_gangsa
end type
type dw_main from cuo_dwwindow_one_hin within w_hin000h_gangsa
end type
type sle_member_no from singlelineedit within w_hin000h_gangsa
end type
type st_8 from statictext within w_hin000h_gangsa
end type
type sle_kname from singlelineedit within w_hin000h_gangsa
end type
type st_1 from statictext within w_hin000h_gangsa
end type
type gb_1 from groupbox within w_hin000h_gangsa
end type
type st_2 from statictext within w_hin000h_gangsa
end type
end forward
...
global w_hin000h_gangsa w_hin000h_gangsa
...
integer height = 1208
integer taborder = 20
string dataobject = "d_hin000h_gangsa"
end type
