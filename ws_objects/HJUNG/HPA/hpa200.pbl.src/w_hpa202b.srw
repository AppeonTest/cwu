$PBExportHeader$w_hpa202b.srw
$PBExportComments$사학연금상환 생성/관리
forward
global type w_hpa202b from w_tabsheet
end type
...
type uo_yearmonth from cuo_yearmonth within w_hpa202b
end type
end forward

global type w_hpa202b from w_tabsheet
string title = "사학연금상환 생성/관리"
uo_yearmonth uo_yearmonth
end type
global w_hpa202b w_hpa202b
...
integer	li_find, i, li_column, li_start, li_col_len[] = {5, 6, 13, 15, 9, 6, 3, 3, 9, 9, 9, 1, 9}
...
type ln_templeft from w_tabsheet`ln_templeft within w_hpa202b
end type

type ln_tempright from w_tabsheet`ln_tempright within w_hpa202b
end type

type ln_temptop from w_tabsheet`ln_temptop within w_hpa202b
end type

type ln_tempbuttom from w_tabsheet`ln_tempbuttom within w_hpa202b
end type

type ln_tempbutton from w_tabsheet`ln_tempbutton within w_hpa202b
end type

type ln_tempstart from w_tabsheet`ln_tempstart within w_hpa202b
end type

type uc_retrieve from w_tabsheet`uc_retrieve within w_hpa202b
end type

type uc_insert from w_tabsheet`uc_insert within w_hpa202b
end type

type uc_delete from w_tabsheet`uc_delete within w_hpa202b
end type

type uc_save from w_tabsheet`uc_save within w_hpa202b
end type

type uc_excel from w_tabsheet`uc_excel within w_hpa202b
end type

type uc_print from w_tabsheet`uc_print within w_hpa202b
end type

type st_line1 from w_tabsheet`st_line1 within w_hpa202b
...
type st_line2 from w_tabsheet`st_line2 within w_hpa202b
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
string facename = "Tahoma"
...
type st_line3 from w_tabsheet`st_line3 within w_hpa202b
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
string facename = "Tahoma"
...
type uc_excelroad from w_tabsheet`uc_excelroad within w_hpa202b
end type

type ln_dwcon from w_tabsheet`ln_dwcon within w_hpa202b
end type

type tab_sheet from w_tabsheet`tab_sheet within w_hpa202b
integer x = 46
integer y = 324
integer width = 4389
integer height = 2296
...
type uo_tab from w_tabsheet`uo_tab within w_hpa202b
integer x = 1152
integer y = 324
long backcolor = 1073741824
end type

type dw_con from w_tabsheet`dw_con within w_hpa202b
boolean visible = false
integer width = 0
integer height = 0
end type

type st_con from w_tabsheet`st_con within w_hpa202b
end type
