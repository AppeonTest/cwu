$PBExportHeader$w_hpa304b.srw
$PBExportComments$월 세금계산 생성(전체/학과별 생성)
forward
global type w_hpa304b from w_tabsheet
end type
type tabpage_sheet02 from userobject within tab_sheet
end type
type tabpage_sheet02 from userobject within tab_sheet
end type
type rb_1 from radiobutton within w_hpa304b
end type
type rb_2 from radiobutton within w_hpa304b
end type
type hpb_1 from hprogressbar within w_hpa304b
end type
type st_status from statictext within w_hpa304b
end type
type cb_1 from commandbutton within w_hpa304b
end type
type gb_4 from groupbox within w_hpa304b
end type
type uo_yearmonth from cuo_yearmonth within w_hpa304b
end type
type uo_dept_code from cuo_dept within w_hpa304b
end type
type st_2 from statictext within w_hpa304b
end type
type st_1 from statictext within w_hpa304b
end type
type dw_head from datawindow within w_hpa304b
end type
type st_3 from statictext within w_hpa304b
end type
type em_per from editmask within w_hpa304b
end type
type st_4 from statictext within w_hpa304b
end type
type cbx_1 from checkbox within w_hpa304b
end type
type cbx_2 from checkbox within w_hpa304b
end type
type cbx_3 from checkbox within w_hpa304b
end type
type cbx_4 from checkbox within w_hpa304b
end type
type cbx_5 from checkbox within w_hpa304b
end type
type dw_list004 from datawindow within w_hpa304b
end type
type em_pay_date from editmask within w_hpa304b
end type
type uo_insa from cuo_insa_member within w_hpa304b
end type
type dw_list002 from uo_dwgrid within w_hpa304b
end type
type dw_list003 from uo_dwgrid within w_hpa304b
end type
type pb_1 from uo_imgbtn within w_hpa304b
end type
end forward
...
// 세금계산자료가 있는지 확인한다.
if dw_list003.retrieve(is_yearmonth, is_dept_code, is_item1, is_item2, ii_str_jikjong, ii_end_jikjong, ls_member) > 0 then
...
for ll_cnt1	= 1 to ll_count
	...
	li_wife_num			  =	dw_list002.getitemnumber(ll_cnt1, 'wife_num')
	li_support_20		  =	dw_list002.getitemnumber(ll_cnt1, 'support_20')
	li_support_60		  =	dw_list002.getitemnumber(ll_cnt1, 'support_60')
	li_handycap			  =	dw_list002.getitemnumber(ll_cnt1, 'handycap')
	li_old_num		  	  =	dw_list002.getitemnumber(ll_cnt1, 'old_num')
	ls_woman				  =	dw_list002.getitemstring(ll_cnt1, 'woman')
	ldb_contribution	  =	dw_list002.getitemnumber(ll_cnt1, 'contribution')
	ldb_amt_sum			  =	dw_list002.getitemnumber(ll_cnt1, 'amt_sum')
	ldb_nontax_sum		  =	dw_list002.getitemnumber(ll_cnt1, 'nontax_sum')
	ldb_pension         =	dw_list002.getitemnumber(ll_cnt1, 'insure_pension')
//	ldb_medi_amt        =	dw_list002.getitemnumber(ll_cnt1, 'medi_amt')
	li_jaejik_opt		  =	dw_list002.getitemnumber(ll_cnt1, 'jaejik_opt')
...
dw_list002.retrieve(is_yearmonth, is_dept_code, ii_str_jikjong, ii_end_jikjong, ls_member, ls_chasu)
dw_list003.retrieve(is_yearmonth, is_dept_code, is_item1, is_item2, ii_str_jikjong, ii_end_jikjong, ls_member)
...
this.Control[iCurrent+7]=this.uo_yearmonth
this.Control[iCurrent+8]=this.uo_dept_code
this.Control[iCurrent+9]=this.st_2
this.Control[iCurrent+10]=this.st_1
this.Control[iCurrent+11]=this.dw_head
this.Control[iCurrent+12]=this.st_3
this.Control[iCurrent+13]=this.em_per
...
this.Control[iCurrent+20]=this.dw_list004
this.Control[iCurrent+21]=this.em_pay_date
this.Control[iCurrent+22]=this.uo_insa
this.Control[iCurrent+23]=this.dw_list002
this.Control[iCurrent+24]=this.dw_list003
this.Control[iCurrent+25]=this.pb_1
end on

on w_hpa304b.destroy
call super::destroy
destroy(this.rb_1)
destroy(this.rb_2)
destroy(this.hpb_1)
...
type ln_templeft from w_tabsheet`ln_templeft within w_hpa304b
end type

type ln_tempright from w_tabsheet`ln_tempright within w_hpa304b
end type

type ln_temptop from w_tabsheet`ln_temptop within w_hpa304b
end type

type ln_tempbuttom from w_tabsheet`ln_tempbuttom within w_hpa304b
end type

type ln_tempbutton from w_tabsheet`ln_tempbutton within w_hpa304b
end type

type ln_tempstart from w_tabsheet`ln_tempstart within w_hpa304b
end type

type uc_retrieve from w_tabsheet`uc_retrieve within w_hpa304b
end type

type uc_insert from w_tabsheet`uc_insert within w_hpa304b
end type

type uc_delete from w_tabsheet`uc_delete within w_hpa304b
end type

type uc_save from w_tabsheet`uc_save within w_hpa304b
end type

type uc_excel from w_tabsheet`uc_excel within w_hpa304b
end type

type uc_print from w_tabsheet`uc_print within w_hpa304b
end type

type st_line1 from w_tabsheet`st_line1 within w_hpa304b
end type

type st_line2 from w_tabsheet`st_line2 within w_hpa304b
end type

type st_line3 from w_tabsheet`st_line3 within w_hpa304b
end type

type uc_excelroad from w_tabsheet`uc_excelroad within w_hpa304b
end type

type ln_dwcon from w_tabsheet`ln_dwcon within w_hpa304b
end type

type tab_sheet from w_tabsheet`tab_sheet within w_hpa304b
...
type uo_tab from w_tabsheet`uo_tab within w_hpa304b
integer x = 1966
integer y = 1792
end type

type dw_con from w_tabsheet`dw_con within w_hpa304b
boolean visible = false
end type

type st_con from w_tabsheet`st_con within w_hpa304b
integer height = 380
...
// 항목구분
dw_list002.getchild('excepte_gbn', idw_child)
idw_child.settransobject(sqlca)
if idw_child.retrieve('excepte_gbn', 0) < 1 then
	idw_child.reset()
	idw_child.insertrow(0)
...
IF NOT PARENT.TRIGGER EVENT ue_check_option() = 0 THEN RETURN 
...
if	li_rtn = 0 then
	...
	f_messagebox('1', string(dw_list002.rowcount()) + '건의 자료를 생성했습니다.!')
