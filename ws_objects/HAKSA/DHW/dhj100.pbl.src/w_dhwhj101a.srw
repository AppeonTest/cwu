$PBExportHeader$w_dhwhj101a.srw
$PBExportComments$[대학원] 학적코드관리
forward
global type w_dhwhj101a from w_no_condition_window
end type
type tab_1 from tab within w_dhwhj101a
end type
...
type uo_1 from u_tab within w_dhwhj101a
end type
end forward
...
global w_dhwhj101a w_dhwhj101a
...
type ln_templeft from w_no_condition_window`ln_templeft within w_dhwhj101a
end type

type ln_tempright from w_no_condition_window`ln_tempright within w_dhwhj101a
end type

type ln_temptop from w_no_condition_window`ln_temptop within w_dhwhj101a
end type

type ln_tempbuttom from w_no_condition_window`ln_tempbuttom within w_dhwhj101a
end type

type ln_tempbutton from w_no_condition_window`ln_tempbutton within w_dhwhj101a
end type

type ln_tempstart from w_no_condition_window`ln_tempstart within w_dhwhj101a
end type

type uc_retrieve from w_no_condition_window`uc_retrieve within w_dhwhj101a
end type

type uc_insert from w_no_condition_window`uc_insert within w_dhwhj101a
end type

type uc_delete from w_no_condition_window`uc_delete within w_dhwhj101a
end type

type uc_save from w_no_condition_window`uc_save within w_dhwhj101a
end type

type uc_excel from w_no_condition_window`uc_excel within w_dhwhj101a
end type

type uc_print from w_no_condition_window`uc_print within w_dhwhj101a
end type

type st_line1 from w_no_condition_window`st_line1 within w_dhwhj101a
end type

type st_line2 from w_no_condition_window`st_line2 within w_dhwhj101a
end type

type st_line3 from w_no_condition_window`st_line3 within w_dhwhj101a
end type

type uc_excelroad from w_no_condition_window`uc_excelroad within w_dhwhj101a
end type

type ln_dwcon from w_no_condition_window`ln_dwcon within w_dhwhj101a
end type

type gb_1 from w_no_condition_window`gb_1 within w_dhwhj101a
end type
...
integer taborder = 20
boolean bringtotop = true
string dataobject = "d_dhwhj101a_01"
end type
...
integer height = 1860
integer taborder = 11
string dataobject = "d_dhwhj101a_02"
end type
...
integer height = 1852
integer taborder = 11
string dataobject = "d_dhwhj101a_03"
end type
...
integer height = 1856
integer taborder = 11
string dataobject = "d_dhwhj101a_04"
end type
...
integer height = 1856
integer taborder = 11
string dataobject = "d_dhwhj101a_05"
end type
...
integer height = 1856
integer taborder = 11
string dataobject = "d_dhwhj101a_06"
end type
...
integer height = 1848
integer taborder = 11
string dataobject = "d_dhwhj101a_07"
end type
...
integer height = 1852
integer taborder = 11
string dataobject = "d_dhwhj101a_08"
end type
...
integer height = 1852
integer taborder = 11
string dataobject = "d_dhwhj101a_09"
end type
...
integer height = 1856
integer taborder = 11
string dataobject = "d_dhwhj101a_10"
end type
