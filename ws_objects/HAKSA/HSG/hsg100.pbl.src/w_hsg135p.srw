$PBExportHeader$w_hsg135p.srw
$PBExportComments$[w_list] 월별조회
forward
global type w_hsg135p from w_window
end type
type dw_main from uo_grid within w_hsg135p
end type
type dw_con from uo_dw within w_hsg135p
end type
type p_1 from picture within w_hsg135p
end type
type st_main from statictext within w_hsg135p
end type
end forward
...
type ln_templeft from w_window`ln_templeft within w_hsg135p
end type

type ln_tempright from w_window`ln_tempright within w_hsg135p
end type

type ln_temptop from w_window`ln_temptop within w_hsg135p
end type

type ln_tempbuttom from w_window`ln_tempbuttom within w_hsg135p
end type

type ln_tempbutton from w_window`ln_tempbutton within w_hsg135p
end type

type ln_tempstart from w_window`ln_tempstart within w_hsg135p
end type

type uc_retrieve from w_window`uc_retrieve within w_hsg135p
end type

type uc_insert from w_window`uc_insert within w_hsg135p
end type

type uc_delete from w_window`uc_delete within w_hsg135p
end type

type uc_save from w_window`uc_save within w_hsg135p
end type

type uc_excel from w_window`uc_excel within w_hsg135p
end type

type uc_print from w_window`uc_print within w_hsg135p
end type

type st_line1 from w_window`st_line1 within w_hsg135p
end type

type st_line2 from w_window`st_line2 within w_hsg135p
end type

type st_line3 from w_window`st_line3 within w_hsg135p
end type

type uc_excelroad from w_window`uc_excelroad within w_hsg135p
end type
