$PBExportHeader$w_hsu503p.srw
$PBExportComments$[청운대]수강확인원
forward
global type w_hsu503p from w_condition_window
end type
type dw_1 from uo_search_dwc within w_hsu503p
end type
type dw_main from datawindow within w_hsu503p
end type
type dw_con from uo_dwfree within w_hsu503p
end type
type uo_1 from uo_imgbtn within w_hsu503p
end type
end forward
...
string 	ls_year,	ls_hakgi, ls_hakbun, ls_jumin_no
...
ls_jumin_no =  func.of_nvl(dw_con.Object.jumin_no[1], '%')
	
li_row = dw_1.retrieve(ls_year, ls_hakgi, ls_hakbun, ls_jumin_no)	
...
type ln_templeft from w_condition_window`ln_templeft within w_hsu503p
end type

type ln_tempright from w_condition_window`ln_tempright within w_hsu503p
end type

type ln_temptop from w_condition_window`ln_temptop within w_hsu503p
end type

type ln_tempbuttom from w_condition_window`ln_tempbuttom within w_hsu503p
end type

type ln_tempbutton from w_condition_window`ln_tempbutton within w_hsu503p
end type

type ln_tempstart from w_condition_window`ln_tempstart within w_hsu503p
end type

type uc_retrieve from w_condition_window`uc_retrieve within w_hsu503p
end type

type uc_insert from w_condition_window`uc_insert within w_hsu503p
end type

type uc_delete from w_condition_window`uc_delete within w_hsu503p
end type

type uc_save from w_condition_window`uc_save within w_hsu503p
end type

type uc_excel from w_condition_window`uc_excel within w_hsu503p
end type

type uc_print from w_condition_window`uc_print within w_hsu503p
end type

type st_line1 from w_condition_window`st_line1 within w_hsu503p
end type

type st_line2 from w_condition_window`st_line2 within w_hsu503p
end type

type st_line3 from w_condition_window`st_line3 within w_hsu503p
end type

type uc_excelroad from w_condition_window`uc_excelroad within w_hsu503p
end type

type ln_dwcon from w_condition_window`ln_dwcon within w_hsu503p
end type

type gb_1 from w_condition_window`gb_1 within w_hsu503p
end type

type gb_2 from w_condition_window`gb_2 within w_hsu503p
end type
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_hsu500p_3_1"
...
integer taborder = 80
boolean bringtotop = true
string dataobject = "d_hsu503p_c1"
boolean border = false
...
integer taborder = 50
boolean bringtotop = true
string btnname = "시간표 출력"
end type

event clicked;call super::clicked;string	ls_year, ls_hakgi, ls_hakbun, ls_jumin, ls_gwa, ls_hakyun, ls_name
integer	count=0
long		ll_newrow=0
