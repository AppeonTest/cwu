$PBExportHeader$w_hsu208p.srw
$PBExportComments$[청운대]휴보강신청서_조회,출력
forward
global type w_hsu208p from w_condition_window
end type
type dw_main from uo_search_dwc within w_hsu208p
end type
type dw_con from uo_dwfree within w_hsu208p
end type
type dw_search from uo_dwfree within w_hsu208p
end type
end forward
...
type ln_templeft from w_condition_window`ln_templeft within w_hsu208p
end type

type ln_tempright from w_condition_window`ln_tempright within w_hsu208p
end type

type ln_temptop from w_condition_window`ln_temptop within w_hsu208p
end type

type ln_tempbuttom from w_condition_window`ln_tempbuttom within w_hsu208p
end type

type ln_tempbutton from w_condition_window`ln_tempbutton within w_hsu208p
end type

type ln_tempstart from w_condition_window`ln_tempstart within w_hsu208p
end type

type uc_retrieve from w_condition_window`uc_retrieve within w_hsu208p
end type

type uc_insert from w_condition_window`uc_insert within w_hsu208p
end type

type uc_delete from w_condition_window`uc_delete within w_hsu208p
end type

type uc_save from w_condition_window`uc_save within w_hsu208p
end type

type uc_excel from w_condition_window`uc_excel within w_hsu208p
end type

type uc_print from w_condition_window`uc_print within w_hsu208p
end type

type st_line1 from w_condition_window`st_line1 within w_hsu208p
end type

type st_line2 from w_condition_window`st_line2 within w_hsu208p
end type

type st_line3 from w_condition_window`st_line3 within w_hsu208p
end type

type uc_excelroad from w_condition_window`uc_excelroad within w_hsu208p
end type

type ln_dwcon from w_condition_window`ln_dwcon within w_hsu208p
end type

type gb_1 from w_condition_window`gb_1 within w_hsu208p
end type

type gb_2 from w_condition_window`gb_2 within w_hsu208p
end type
