$PBExportHeader$w_hml203p.srw
$PBExportComments$[w_list_list] 개인별마일리지현황
forward
global type w_hml203p from w_window
end type
type dw_list from uo_grid within w_hml203p
end type
type dw_con from uo_dw within w_hml203p
end type
type dw_main from uo_grid within w_hml203p
end type
type uc_row_insert from u_picture within w_hml203p
end type
type uc_row_delete from u_picture within w_hml203p
end type
type st_main from statictext within w_hml203p
end type
type p_1 from picture within w_hml203p
end type
type p_2 from picture within w_hml203p
end type
type st_detail from statictext within w_hml203p
end type
end forward
...
avc_data.SetProperty('title', "개인별 마일리지현황")
...
type ln_templeft from w_window`ln_templeft within w_hml203p
end type

type ln_tempright from w_window`ln_tempright within w_hml203p
end type

type ln_temptop from w_window`ln_temptop within w_hml203p
end type

type ln_tempbuttom from w_window`ln_tempbuttom within w_hml203p
end type

type ln_tempbutton from w_window`ln_tempbutton within w_hml203p
end type

type ln_tempstart from w_window`ln_tempstart within w_hml203p
end type

type uc_retrieve from w_window`uc_retrieve within w_hml203p
end type

type uc_insert from w_window`uc_insert within w_hml203p
end type

type uc_delete from w_window`uc_delete within w_hml203p
end type

type uc_save from w_window`uc_save within w_hml203p
end type

type uc_excel from w_window`uc_excel within w_hml203p
end type

type uc_print from w_window`uc_print within w_hml203p
end type

type st_line1 from w_window`st_line1 within w_hml203p
end type

type st_line2 from w_window`st_line2 within w_hml203p
end type

type st_line3 from w_window`st_line3 within w_hml203p
end type

type uc_excelroad from w_window`uc_excelroad within w_hml203p
end type
...
string dataobject = "d_hml203p_1"
boolean hscrollbar = true
boolean vscrollbar = true
boolean border = false
end type

event type long ue_retrieve();String		ls_year, ls_gwa, ls_sex, ls_hakbun
Long		ll_rv
...
dw_main.Reset()
ll_rv = THIS.Retrieve(ls_year, ls_gwa, ls_sex, ls_hakbun)
...
integer taborder = 10
boolean bringtotop = true
string dataobject = "d_hml203p_con"
boolean border = false
