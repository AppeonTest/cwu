$PBExportHeader$w_sys202a.srw
$PBExportComments$공지사항댓글등록
forward
global type w_sys202a from w_ancresponse
end type
type uc_row_delete from u_picture within w_sys202a
end type
type uc_row_insert from u_picture within w_sys202a
end type
type st_detail from statictext within w_sys202a
end type
type p_2 from picture within w_sys202a
end type
type st_main from statictext within w_sys202a
end type
type p_1 from picture within w_sys202a
end type
type dw_list from uo_grid within w_sys202a
end type
type dw_main from uo_dw within w_sys202a
end type
type p_msg from picture within w_sys202a
end type
type st_msg from statictext within w_sys202a
end type
type uc_printpreview from u_picture within w_sys202a
end type
type uc_cancel from u_picture within w_sys202a
end type
type uc_ok from u_picture within w_sys202a
end type
type uc_excelroad from u_picture within w_sys202a
end type
type uc_excel from u_picture within w_sys202a
end type
type uc_save from u_picture within w_sys202a
end type
type uc_delete from u_picture within w_sys202a
end type
type uc_insert from u_picture within w_sys202a
end type
type uc_retrieve from u_picture within w_sys202a
end type
type ln_temptop from line within w_sys202a
end type
type ln_1 from line within w_sys202a
end type
type ln_2 from line within w_sys202a
end type
type ln_3 from line within w_sys202a
end type
type r_backline1 from rectangle within w_sys202a
end type
type r_backline2 from rectangle within w_sys202a
end type
type r_backline3 from rectangle within w_sys202a
end type
type uc_print from u_picture within w_sys202a
end type
end forward
...
ls_board_gb = ivc.GetProperty("board_gb")
ls_make_dt =  ivc.GetProperty("make_dt")
li_board_seq = Long(ivc.GetProperty("board_seq"))

ll_rv = dw_main.Retrieve(ls_board_gb,ls_make_dt, li_board_seq)

If ll_rv > 0 Then
	dw_list.Retrieve(ls_board_gb,ls_make_dt, li_board_seq)
End If
...
li_make_seq	= dw_main.Object.board_seq[li_row]

For i = 1 To dw_list.RowCount()
	l_status = func.of_getrowstatus(dw_list, i)
	If i = 1 Then 
		li_dseq = 1
	Else
		li_dseq = dw_list.Object.board_dseq[i - 1] + 1
	End If
	
	If l_status = NewModified! Then
		dw_list.Object.board_gb[i] = ls_board_gb
		dw_list.Object.make_dt[i] 	= ls_make_dt
		dw_list.Object.board_seq[i] 	= li_make_seq
		dw_list.Object.board_dseq[i] 	= li_dseq
	End If
Next
...
this.Control[iCurrent+1]=this.uc_row_delete
this.Control[iCurrent+2]=this.uc_row_insert
...
this.Control[iCurrent+9]=this.p_msg
this.Control[iCurrent+10]=this.st_msg
this.Control[iCurrent+11]=this.uc_printpreview
this.Control[iCurrent+12]=this.uc_cancel
this.Control[iCurrent+13]=this.uc_ok
this.Control[iCurrent+14]=this.uc_excelroad
this.Control[iCurrent+15]=this.uc_excel
this.Control[iCurrent+16]=this.uc_save
this.Control[iCurrent+17]=this.uc_delete
this.Control[iCurrent+18]=this.uc_insert
this.Control[iCurrent+19]=this.uc_retrieve
this.Control[iCurrent+20]=this.ln_temptop
this.Control[iCurrent+21]=this.ln_1
this.Control[iCurrent+22]=this.ln_2
this.Control[iCurrent+23]=this.ln_3
this.Control[iCurrent+24]=this.r_backline1
this.Control[iCurrent+25]=this.r_backline2
this.Control[iCurrent+26]=this.r_backline3
this.Control[iCurrent+27]=this.uc_print
end on

on w_sys202a.destroy
call super::destroy
...
This.Event ue_resize_dw( r_backline1, dw_list )
...
event clicked;call super::clicked;dw_list.PostEvent("ue_DeleteRow")
...
event clicked;call super::clicked;If dw_main.GetRow() > 0 Then
	dw_list.PostEvent("ue_InsertRow")
End If
...
integer height = 440
integer taborder = 20
string dataobject = "d_sys202a_2"
boolean border = false
borderstyle borderstyle = stylebox!
boolean ib_end_add = true
end type

event ue_insertend;call super::ue_insertend;This.Object.member_no[al_row] = gs_empcode
