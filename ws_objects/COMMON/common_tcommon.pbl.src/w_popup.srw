...
$PBExportComments$POP-UP Window - 입출력용
forward
global type w_popup from w_ancresponse
end type
type p_msg from picture within w_popup
end type
type st_msg from statictext within w_popup
end type
type uc_printpreview from u_picture within w_popup
end type
type uc_cancel from u_picture within w_popup
end type
type uc_ok from u_picture within w_popup
end type
type uc_excelroad from u_picture within w_popup
end type
type uc_excel from u_picture within w_popup
end type
type uc_save from u_picture within w_popup
end type
type uc_delete from u_picture within w_popup
end type
type uc_insert from u_picture within w_popup
end type
type uc_retrieve from u_picture within w_popup
end type
type ln_temptop from line within w_popup
end type
type ln_1 from line within w_popup
end type
type ln_2 from line within w_popup
end type
type ln_3 from line within w_popup
end type
type r_backline1 from rectangle within w_popup
end type
type r_backline2 from rectangle within w_popup
end type
type r_backline3 from rectangle within w_popup
end type
type uc_print from u_picture within w_popup
end type
end forward
