$PBExportHeader$uo_haksagrid.sru
$PBExportComments$DataObject - Grid 용(학사)
forward
global type uo_haksagrid from u_dw
end type
end forward
...
global uo_haksagrid uo_haksagrid
...
on uo_haksagrid.create
call super::create
end on

on uo_haksagrid.destroy
call super::destroy
end on
...
event constructor;call super::constructor;This.SetRedraw(False)
//V1.9.9.009 오류 발생
