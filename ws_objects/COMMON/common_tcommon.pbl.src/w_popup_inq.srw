$PBExportHeader$w_popup_inq.srw
$PBExportComments$POP-UP Window - Only 조회
forward
global type w_popup_inq from w_ancresponse
end type
type p_msg from picture within w_popup_inq
end type
type st_msg from statictext within w_popup_inq
end type
type uc_printpreview from u_picture within w_popup_inq
end type
type uc_cancel from u_picture within w_popup_inq
end type
type uc_ok from u_picture within w_popup_inq
end type
type uc_excel from u_picture within w_popup_inq
end type
type uc_retrieve from u_picture within w_popup_inq
end type
type ln_temptop from line within w_popup_inq
end type
type ln_1 from line within w_popup_inq
end type
type ln_2 from line within w_popup_inq
end type
type ln_3 from line within w_popup_inq
end type
type r_backline1 from rectangle within w_popup_inq
end type
type r_backline2 from rectangle within w_popup_inq
end type
type r_backline3 from rectangle within w_popup_inq
end type
type uc_print from u_picture within w_popup_inq
end type
end forward
...
global w_popup_inq w_popup_inq
...
this.Control[iCurrent+7]=this.uc_retrieve
this.Control[iCurrent+8]=this.ln_temptop
this.Control[iCurrent+9]=this.ln_1
this.Control[iCurrent+10]=this.ln_2
this.Control[iCurrent+11]=this.ln_3
this.Control[iCurrent+12]=this.r_backline1
this.Control[iCurrent+13]=this.r_backline2
this.Control[iCurrent+14]=this.r_backline3
this.Control[iCurrent+15]=this.uc_print
end on

on w_popup_inq.destroy
call super::destroy
destroy(this.p_msg)
destroy(this.st_msg)
