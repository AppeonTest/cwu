...
$PBExportComments$메인 상속윈도우 - 신규개발용
forward
global type w_window from w_ancsheet
end type
type uc_retrieve from u_picture within w_window
end type
type uc_insert from u_picture within w_window
end type
type uc_delete from u_picture within w_window
end type
type uc_save from u_picture within w_window
end type
type uc_excel from u_picture within w_window
end type
type uc_print from u_picture within w_window
end type
type st_line1 from statictext within w_window
end type
type st_line2 from statictext within w_window
end type
type st_line3 from statictext within w_window
end type
type uc_excelroad from u_picture within w_window
end type
end forward
...
type ln_templeft from w_ancsheet`ln_templeft within w_window
integer endy = 2312
end type

type ln_tempright from w_ancsheet`ln_tempright within w_window
integer endy = 2312
end type

type ln_temptop from w_ancsheet`ln_temptop within w_window
end type

type ln_tempbuttom from w_ancsheet`ln_tempbuttom within w_window
integer beginy = 2264
integer endy = 2264
end type

type ln_tempbutton from w_ancsheet`ln_tempbutton within w_window
end type

type ln_tempstart from w_ancsheet`ln_tempstart within w_window
end type
